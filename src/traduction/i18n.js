  ...
  resources: {
    en: {
      translation: {
        ...
        advantage_secure_investment_desc: 'The CCCA is a key player, offering you valuable opportunities.',
        advantage_network_strength: 'Network Strength',
        advantage_network_strength_desc: 'Forge connections with other business leaders for guaranteed growth.',
        advantage_access_training: 'Access to Training',
        advantage_access_training_desc: 'Meet member needs with diverse, accessible training programs.',
        advantage_visibility: 'Visibility',
        advantage_visibility_desc: 'The CCCA offers “Company of the Month” advertising space with partners. Reserve your month!',
        advantage_influential_partnership: 'Influential Partnership',
        advantage_influential_partnership_desc: 'Numerous opportunities to get involved as an annual partner or event sponsor with CCCA.',
        advantage_exclusive_offers: 'Exclusive Offers',
        advantage_exclusive_offers_desc: 'Save with member-to-member promotions offered by CCCA.',

        // Home Component
        upcoming_event: 'Upcoming Event',
        main_event_description: 'Sustainable Construction and Wood Transformation Expo: A Bridge Between Canada and Africa',
        ...
        devenir_membre: {
          ...
          membership_levels: {
            student: {
              ...
              description: 'For students interested in business and seeking to connect with the business community in Quebec and Africa',
              benefits: [
            ...
            startup: {
              title: 'Startup',
              description: 'For newly established companies operating for less than two years',
              benefits: [
                'Recognition at our activities or in our communications',
            ...
            political: {
              title: 'Political',
              description: 'For political individuals looking to connect with the business community in Africa and Canada',
              benefits: [
                'Client-partner pricing for public events',
                'Exclusive access to events reserved for partner-clients',
                'For one person'
            ...
            exclusive: {
              title: 'Exclusive',
              description: 'One partner per expertise: "Official service partner of CCCA"',
              benefits: [
                'No employee limit',
                'Client-partner pricing for public events',
                'Exclusive access to events reserved for partner-clients',
...
descrip1: 'Cameroon, often called "Africa in miniature," is a country located in Central Africa, known for its cultural, linguistic, and geographical diversity. This diversity enriches its heritage and reflects the harmonious coexistence of various ethnic groups. Cameroon is also renowned for its rich artistic scene, vibrant music, and traditional dances, illustrating the spirit and creativity of its people.',
descrip2: 'Despite the socio-economic and political challenges it faces, Cameroon continues to demonstrate remarkable resilience. Cameroonians are committed to building a better future, focusing on sustainable development and improving the quality of life.',
advdescript1: 'Cameroon is a Central African country with geographic, cultural and economic diversity which makes it a strategic player in the region. It is made up of several key cities, each playing a particular role in the economic and social development of the country. Here is an overview of four strategic cities in Cameroon and their specificities in terms of economic and development opportunities.',

// Cameroon city descriptions
DescripDla: 'Douala is the economic capital of Cameroon, hosting the region’s most active port and a vital industrial center. The city plays a crucial role in both national and international trade, attracting investments in sectors like energy and services. However, the city faces infrastructure challenges that limit its full potential.',
DescripYnde: 'Yaoundé, the political capital of Cameroon, is the administrative center of the country. The city houses government institutions and many international organizations. Yaoundé is also a university hub, with several universities and research institutes, making it a center for knowledge and education.',
DescripGra: 'Garoua, located in northern Cameroon, is known for its role in agriculture and livestock. The city is an important economic center for cotton, livestock, and other crops. Garoua has significant potential for agro-industrial development, but investments are needed to support its growth.',
DescripBmda: 'Bamenda, located in the Northwest region, is known for its cultural dynamism and mountainous landscapes. The city is a commercial hub for the English-speaking region of Cameroon and plays an important role in cross-border trade with neighboring Nigeria.',
ConcCmr: 'These four strategic cities in Cameroon, with their complementary roles, contribute significantly to the country’s economic development. To fully realize their potential, Cameroon must continue investing in infrastructure and improving local governance to promote sustainable and harmonious development.',

// Angola descriptions
descripAngola1: "Angola, often called the land of resources, is a country located in southern Africa, recognized for its cultural, linguistic and geographical diversity. This wealth is manifested through a unique heritage, reflecting the coexistence of several ethnic groups, including the Ovimbundu , the Kimbundu and the Bakongo. Angola is also famous for its vibrant arts scene, its captivating music, such as kuduro and semba, and its traditional dances that illustrate the creative spirit of its people.",
descripAngola2: "Despite the socio-economic and political challenges it has faced, Angola shows impressive resilience. Angolans are actively engaged in building a better future, with a focus on sustainable development and improving quality of life. quality of life. The country, rich in natural resources such as oil and diamonds, aspires to diversify its economy and reduce its dependence on hydrocarbons.",
advdescriptAngola1: "Angola is a country with geographic and economic diversity which makes it a strategic player in Africa. It is made up of several key cities, each playing a specific role in the economic and social development of the country. Here is an overview of four strategic cities in Angola and their particularities in terms of economic opportunities and development.",

// Angola city descriptions
...
ConcCongo: 'These four strategic cities in Congo, through their complementary roles, contribute significantly to the country’s economic development. Their economic diversity, advantageous geographic locations, and investment opportunities make them essential growth drivers. To reach their full potential, Congo must continue investing in infrastructure and improving local governance, thereby fostering harmonious and sustainable development.',
    ...
    descripBurkinaFaso1: "Also known as 'The Land of Honest Men,' Burkina Faso is a landlocked country in West Africa. This nickname highlights the country's cultural values and the importance placed on integrity and moral conduct. Burkina Faso is also known for its vibrant artistic and cultural scene. Traditional music and dance, such as the captivating rhythms of the djembe drum and the graceful movements of traditional dance troupes, are integral to Burkinabe culture. The country has produced talented musicians, filmmakers, and artists who use their creative expressions to reflect the spirit and aspirations of the Burkinabe people.",
    descripBurkinaFaso2: "In recent years, Burkina Faso has faced security and socio-economic development challenges. However, the Burkinabe people continue to show resilience, determination, and commitment to building a better future for their country.",
    advantageBurkinaFaso: "Burkina Faso is a country with diverse economic potentials, and its cities play an important role in driving economic growth and development. Here are some of Burkina Faso's key cities and their economic potentials:",
    DescripOuagadougou: "As the capital and largest city of Burkina Faso, Ouagadougou serves as the country's administrative, economic, and cultural center. It hosts government institutions, international organizations, and a growing private sector.",
    DescripBoboDioulasso: "Located in the southwestern part of the country, Bobo-Dioulasso is Burkina Faso's second-largest city. It is a major center for trade and industry. Bobo-Dioulasso has a thriving informal sector with bustling markets and workshops producing textiles, handicrafts, and agricultural products.",
    DescripKoudougou: "The third-largest city in Burkina Faso, known as a center for education and commerce. It hosts several universities and vocational training institutions, producing a skilled workforce. Koudougou's economic potential includes agriculture, particularly the production of cash crops such as cotton and cereals.",
    DescripBanfora: "Located in Burkina Faso's Cascades region, Banfora is known for its agricultural productivity and natural attractions. The city benefits from fertile soil and a favorable climate for crops such as sugarcane, mangoes, and cashews.",
    ...
    descripCapeVerde1: "Cape Verde, often called 'the archipelago of winds,' is located off the west coast of Africa. This island nation is known for its cultural and musical diversity, with African, European, and Creole influences. This richness is reflected in a living heritage, where morna, funaná, and other rhythms embody the warm spirit and creativity of its people.",
    descripCapeVerde2: "Despite challenges related to its insularity and scarce natural resources, Cape Verde continues to demonstrate great resilience. Cape Verdeans are actively involved in their country's development, with a focus on sustainability and improving living conditions. With significant tourism potential and a dynamic diaspora, Cape Verde aims to diversify its economy, especially through tourism, renewable energy, and services.",
    advantageCapeVerde: "Cape Verde is an archipelago with multiple facets, with geographic and cultural diversity that makes it a dynamic player in the West African region. It comprises several strategic islands, each playing a specific role in the country's economic and social development. Here is an overview of four key cities in Cape Verde and their unique economic and development opportunities.",
    DescripPraia: "Praia, the capital and largest city of Cape Verde, is the country's political, economic, and cultural center. Located on the island of Santiago, it hosts numerous government institutions and businesses. Praia is the country's main port, facilitating trade with Europe, Africa, and the Americas. However, it faces challenges related to urban development and resource management.",
    DescripMindelo: "Mindelo, located on the island of São Vicente, is known for its deep-water seaport and its role as a cultural and tourist center. It is a hub for artistic gatherings and festivals, attracting visitors and artists. Mindelo has considerable potential for tourism and fishing development, but investments in port and tourism infrastructure are necessary to support its growth.",
    DescripEspargos: "Espargos, located on the island of Sal, is a strategic hub for tourism due to its proximity to Amílcar Cabral International Airport. Sal Island is famous for its beaches and resorts, making this city a key center for high-end tourism development. To maximize this potential, efforts are needed to strengthen infrastructure and diversify tourism offerings.",
    DescripSaoFilipe: "São Filipe, on the island of Fogo, is known for its spectacular volcanic landscapes and agriculture, particularly the production of coffee and wine. The city has historic charm and attracts visitors interested in ecotourism and hiking. To boost its local economy, investments in agriculture and ecotourism are essential, along with better promotion of its unique products internationally.",
    ConcCapeVerde: "These four strategic cities in Cape Verde, through their complementary roles, contribute significantly to the country's economic development. Their economic diversity, advantageous geographic locations, and opportunities make them essential growth drivers. To reach their full potential, Cape Verde must continue investing in infrastructure and strengthening its tourist appeal, fostering harmonious and sustainable development.",

    // Côte d'Ivoire Translations
    CoteDIvoire: "Ivory Coast",
    descripCoteDIvoire1: "Ivory Coast, often referred to as the land of elephants, is a country located in West Africa, known for its cultural, ethnic, and geographical diversity. This cultural richness is reflected in its traditions, lively music, and colorful dances, which showcase the creative spirit of its people. Ivory Coast is also a crossroads of African and international influences, enriching its heritage.",
    descripCoteDIvoire2: "Despite socio-economic and political challenges, Ivory Coast continues to show remarkable resilience. The Ivorian people are committed to building a better future, focusing on sustainable development and improving living conditions.",
    advantageCoteDIvoire: "Côte d'Ivoire is a country with diverse economic potentials, and its cities play a significant role in driving economic growth and development. Here are some of Côte d'Ivoire's key cities and their economic potentials:",
    DescripAbidjan: "As the economic capital and largest city of Ivory Coast, Abidjan serves as the country's commercial and business heart. The city is home to the Autonomous Port of Abidjan, one of the largest ports in West Africa, facilitating international trade. This strategic port, along with a high concentration of financial institutions, industries, and services, attracts many multinational companies, contributing to its economic dynamism.",
    DescripBouake: "The country's second most populous city, located in central Ivory Coast. It serves as an essential commercial and industrial hub, especially in processing agricultural products such as cocoa and coffee. As a transportation crossroads, Bouaké facilitates trade between the north and south of the country. However, efforts are needed to rehabilitate and modernize its infrastructure to encourage sustainable development.",
    DescripSanPedro: "A major seaport on the west coast, plays a crucial role in Ivory Coast's economy. With its deep-water port, the city is a key point for exporting cocoa, coffee, and petroleum products. It attracts investments in the agro-food industry and tourism sector. However, to meet growing demand, San Pedro must develop its port and road infrastructure.",
    ...
    ConcCoteDIvoire: "These four strategic cities in Ivory Coast, each with unique strengths, significantly contribute to the country's economic development. Their economic diversity, advantageous geographical locations, and investment opportunities make them essential growth drivers. To reach their full potential, Ivory Coast must invest further in infrastructure and improve local governance, fostering harmonious and sustainable development.",

     // Gambia Translations
     Gambia: 'Gambia',
     descripGambia1: "Gambia, often called 'the smile of Africa,' is a small country in West Africa, known for its cultural, linguistic, and geographical diversity. This richness is reflected in a living heritage, illustrating the coexistence of several ethnic groups, including the Mandinka, Fula, and Wolof. Gambia is also famous for its dynamic arts scene, captivating music, and traditional dances, embodying the creative spirit and resilience of its people.",
     descripGambia2: "Despite the socio-economic and political challenges it faces, Gambia continues to show remarkable resilience. Gambians are actively working towards building a better future, focusing on sustainable development and improving living conditions. The country, rich in natural resources such as fish, peanuts, and tourism, aims to diversify its economy and reduce its dependence on exporting raw materials.",
     advantageGambia: "Gambia is a multifaceted country with geographic and cultural diversity that makes it a key player in West Africa. It consists of several strategic cities, each playing a specific role in the country's economic and social development. Here is an overview of four key cities in Gambia and their unique economic and development opportunities.",
     DescripBanjul: "Banjul, the capital of Gambia, is the country's economic and administrative center. It hosts the main government institutions and several businesses. Banjul is also an important port, facilitating foreign trade. However, the city faces infrastructure challenges and rapid urban growth, which limit its optimal development.",
     DescripSerrekunda: "Serrekunda, the largest city in Gambia, is a vibrant commercial center. Located near the coast, the city is at the heart of the informal economy and local trade. Serrekunda attracts numerous investors due to its dynamism, but improvements in infrastructure and services are needed to support its rapid growth.",
     DescripBrikama: "Brikama, located in the west of the country, is a key center for agriculture and crafts. The city is surrounded by vast lands suitable for cultivating fruits and vegetables, as well as timber production and traditional crafts. Brikama has significant potential for agro-industrial development, but investments in training and infrastructure are needed to strengthen its role in the local economy.",
     ...
     descripGuineaBissau2: "Despite the socio-economic and political challenges it faces, Guinea-Bissau continues to show remarkable resilience. Bissau-Guineans are actively working towards building a better future, with a focus on sustainable development and improving living conditions. The country, rich in natural resources like cashew nuts, wood, and fishery resources, aims to diversify its economy and reduce its dependence on exporting raw materials.",
     advantageGuineaBissau: "Guinea-Bissau is a multifaceted country with geographic and cultural diversity that makes it a key player in West Africa. It comprises several strategic cities, each playing a specific role in the country's economic and social development. Here is an overview of four key cities in Guinea-Bissau and their unique economic and development opportunities.",
     DescripBissau: "Bissau, the capital and largest city of the country, is the economic and political heart of Guinea-Bissau. It hosts numerous government institutions and international organizations. Bissau is an important port, facilitating trade, particularly for cashew exports. However, the city faces challenges related to infrastructure and urban management to support its development.",
     DescripBafata: "Bafata, located east of Bissau, is a major agricultural center. The city is known for cashew and rice cultivation, which are essential to the country's economy. Bafata has significant potential for agro-industrial development but requires investments in processing and transport infrastructure to maximize productivity and contribute to food security.",
     DescripGabu: "Gabu, located in the east, is vital for livestock and agriculture. The city is a commercial hub for trade with Senegal and Guinea. Gabu has significant potential for agro-pastoral development, but road infrastructure and market access improvements are necessary to stimulate economic growth.",
     DescripBolama: "Bolama, the former capital of Guinea-Bissau, is located on an island in the Bijagos Archipelago. Known for its natural beauty, Bolama has potential for ecotourism and artisanal fishing. However, efforts are needed to modernize its infrastructure and attract investments in the tourism sector.",
     ConcGuineaBissau: "These four strategic cities in Guinea-Bissau, through their complementary roles, contribute significantly to the country's economic development. Their economic diversity, advantageous geographic positions, and investment opportunities make them essential growth drivers. To reach their full potential, Guinea-Bissau must continue investing in infrastructure and improving local governance, fostering harmonious and sustainable development.",
 
     // Liberia Translations
    Liberia: 'Liberia',
    descripLiberia1: "Liberia, often called 'the land of freedom,' is located in West Africa and is known for its cultural, linguistic, and geographical diversity. This richness is reflected in a vibrant heritage, illustrating the coexistence of several ethnic groups, including the Kpelle, Bassa, and Gio. Liberia is also famous for its dynamic music scene, traditional dances, and craftsmanship, embodying the creative spirit and resilience of its people.",
    descripLiberia2: "Despite the socio-economic and political challenges it faces, Liberia continues to show remarkable resilience. Liberians are actively working toward building a better future, focusing on sustainable development and improving living conditions. The country, rich in natural resources like rubber, timber, and iron ore, aims to diversify its economy and reduce its reliance on exporting raw materials.",
    advantageLiberia: "Liberia is a multifaceted country with geographic and cultural diversity, making it a key player in West Africa. It comprises several strategic cities, each playing a specific role in the country's economic and social development. Here is an overview of four key cities in Liberia and their unique economic and development opportunities.",
    DescripMonrovia: "Monrovia, the capital and largest city of Liberia, is the country’s economic and political heart. It hosts numerous government institutions, businesses, and international organizations. Monrovia is a major commercial center, with Freeport serving as a gateway for international trade. However, the city faces challenges related to rapid urbanization and the development of basic infrastructure.",
    ...
    descripMaurice2: "Despite challenges related to global economic fluctuations, Mauritius continues to show remarkable resilience. Mauritians are actively engaged in building a sustainable future, focusing on the development of renewable energy and strengthening the education and healthcare sectors. Once reliant on sugar, the country has successfully diversified its economy toward tourism, financial services, and information technology.",
    advantageMaurice: "Mauritius is a multifaceted country, with geographic and cultural diversity that makes it a key player in the Indian Ocean. It comprises several strategic cities, each playing a specific role in the country's economic and social development.",
    ...
    DescripMahebourg: "Mahébourg, located on the southeast coast, is a historical and cultural center of the island. It is renowned for its colonial heritage and traditional markets. Mahébourg has strong potential for tourism development, especially due to its proximity to the airport and the Blue Bay lagoon.",
    DescripQuatreBornes: "Quatre Bornes, known as the \"city of flowers,\" is a dynamic commercial and residential center in the middle of the island. The city is known for its markets and shopping centers, as well as its pleasant living environment. Quatre Bornes has potential for development in the technology and service sectors.",
    ConcMaurice: "These four strategic cities of Mauritius, through their complementary roles, contribute significantly to the economic development of the island. Their economic diversity, advantageous geographical positions, and investment opportunities make them essential growth drivers.",



      // Mozambique
      nomMozambique: 'Mozambique',
      descripMozambique1: 'Mozambique, often called "the country of ocean horizons," is located in Southern Africa and is known for its cultural, linguistic, and geographical diversity. This richness is expressed through a vibrant heritage that showcases the coexistence of several ethnic groups, including the Makua, Tsonga, and Shona. Mozambique is also renowned for its dynamic art scene, lively music like marrabenta, and traditional dances, which reflect the creative spirit and resilience of its people.',
      descripMozambique2: 'Despite socio-economic and political challenges, Mozambique continues to show remarkable resilience. Mozambicans are actively involved in building a better future, with a focus on sustainable development and improving living conditions. The country, rich in natural resources like natural gas, coal, and seafood, aspires to diversify its economy and reduce its dependence on the export of raw materials.',
      advantageMozambique: 'Mozambique is a multifaceted country with geographical and cultural diversity that makes it a key player in Southern Africa. It comprises several strategic cities, each playing a specific role in the country’s economic and social development. Here is an overview of four key cities in Mozambique and their unique contributions to economic opportunities and development.',
      MaputoDescription: 'Maputo, the capital and largest city of Mozambique, is the economic and political heart of the country. It houses numerous government institutions, businesses, and international organizations. Maputo is a crucial port and commercial center, facilitating trade with South Africa and neighboring countries. However, the city faces challenges in infrastructure and housing to keep up with its rapid growth.',
      BeiraDescription: 'Beira, the second-largest seaport in Mozambique, is an essential logistics center. Located in the country’s center, the city plays a key role in the transportation and export of minerals and agricultural products worldwide. However, the development of Beira requires improvements in port infrastructure to meet growing demand and strengthen its resilience to cyclones.',
      ...
      advantageZambie: 'Zambia is a multifaceted country with geographical and cultural diversity that makes it a key player in Southern Africa. It comprises several strategic cities, each playing a specific role in the country’s economic and social development. Here’s an overview of four key cities in Zambia and their unique contributions to economic opportunities and development.',
      LusakaDescription: 'Lusaka, the capital and largest city of Zambia, is the economic and political heart of the country. It houses many government institutions, businesses, and international organizations. Lusaka is a major commercial hub, connecting the country to neighboring markets. However, the city faces infrastructure challenges and rapid urbanization, requiring investments to optimize its development.',
      ...
      NouakchottDescription: 'Nouakchott, the capital and largest city of Mauritania, is the economic and political heart of the country. It hosts numerous government institutions, businesses, and international organizations. Nouakchott is also the main port of the country, facilitating trade with the rest of the world. However, the city faces challenges related to rapid urban growth and infrastructure.',
      NouadhibouDescription: 'Nouadhibou, located on the northwest coast, is Mauritania’s industrial and port center. The city plays a key role in exporting iron and fishing products. With its deep-water port, Nouadhibou is a hub for investment in mining and fishing industries. To support its growth, infrastructure improvements are needed to maximize its potential.',
      ZouerateDescription: 'Zouerate, located in the north, is known for its central role in Mauritania’s mining industry. The city is the main center for iron ore production, a key resource for the national economy. Zouerate’s development relies on expanding mining operations and improving transportation infrastructure to transport iron to Nouadhibou.',
      KaediDescription: 'Kaédi, located in the south along the Senegal River, is an important center for agriculture and livestock. The city benefits from fertile land for cultivating rice, corn, and vegetables. Kaédi has significant potential for agro-industrial development, but to make the most of it, investments in agricultural infrastructure and farmer training are needed.',
      conclusionMauritanie: 'These four strategic cities in Mauritania, with their complementary roles, contribute significantly to the country’s economic development. Their economic diversity, advantageous geographical positions, and investment opportunities make them essential growth engines. To realize their full potential, Mauritania must continue to invest in infrastructure and improve local governance, fostering harmonious and sustainable development.',

      // Sudan (Soudan)
      nomSoudan: 'Sudan',
      descripSoudan1: 'Sudan, often called "the land of ancient civilizations," is located in Northeast Africa and is known for its cultural, linguistic, and geographical diversity. This richness is reflected in a vibrant heritage showcasing the coexistence of various ethnic groups, including Arabs, Beja, and Nubians. Sudan is also renowned for its traditional art scene, music, and dances, which highlight the creative spirit and resilience of its people.',
      descripSoudan2: 'Despite socio-economic and political challenges, Sudan continues to show remarkable resilience. Sudanese people are actively working towards building a better future, with a focus on sustainable development and improving living conditions. The country, rich in natural resources like oil, gold, and arable land, aims to diversify its economy and reduce its dependence on raw material exports.',
      advantageSoudan: 'Sudan is a multifaceted country, with geographical and cultural diversity that makes it a key player in Africa. It comprises several strategic cities, each playing a specific role in the country’s economic and social development. Here is an overview of four key cities in Sudan and their unique opportunities for economic growth and development.',
      KhartoumDescription: 'Khartoum, the capital and largest city of Sudan, is the economic and political heart of the country. It hosts numerous government institutions, businesses, and international organizations. Khartoum is a major commercial hub, facilitating trade between Sudan and its African neighbors. However, the city faces infrastructure challenges and rapid urbanization, limiting its optimal development.',
      PortSoudanDescription: 'Port Sudan, the country’s main seaport, is a crucial industrial and commercial center. The city plays a key role in exporting petroleum products and minerals to international markets. Port Sudan attracts investments in logistics and port services, yet it requires infrastructure improvements to support growth and meet business demands.',
      ElObeidDescription: 'El-Obeid, located in central Sudan, is an important agricultural and commercial center. The city is known for its production of natural gums, grains, and livestock. El-Obeid has significant potential for agro-industrial development, but investments in transportation infrastructure and farmer training are needed to maximize its output.',
      ...
      conclusionSoudan: 'These four strategic cities in Sudan, with their complementary roles, contribute significantly to the country’s economic development. Their economic diversity, advantageous geographical positions, and investment opportunities make them essential growth engines. To realize their full potential, Sudan must continue to invest in infrastructure and improve local governance, fostering harmonious and sustainable development.',
       ...
       descripBotswana1: "Botswana, located in southern Africa, is known for its political stability, good governance, and vast natural resources. Nicknamed 'the land of diamonds,' Botswana is also famous for its impressive biodiversity, particularly in Chobe National Park and the Okavango Delta, a UNESCO World Heritage site. This natural wealth makes Botswana a popular destination for tourism, offering opportunities for sustainable development.",
       descripBotswana2: "Despite challenges related to poverty and reliance on mineral resources, Botswana continues to demonstrate remarkable resilience by investing in education, healthcare, and infrastructure to foster inclusive growth.",
       advantageBotswana: 'Botswana has a diversified economy that leverages its natural resources and human capital. Here is an overview of three key cities in the country and their unique economic and development opportunities.',
       ...
       advantageSuaziland: 'Eswatini is a multifaceted country, with geographical and cultural diversity that makes it a unique player in southern Africa. It comprises several strategic cities, each playing a specific role in the country’s economic and social development. Here is an overview of four key cities in Eswatini and their unique economic and development opportunities.',
       MbabaneDescription: "Mbabane, the administrative capital of Eswatini, is the political and economic center of the country. It hosts numerous government institutions and international organizations. Located in the heart of the mountains, Mbabane plays an important role in the services sector but must overcome urbanization and infrastructure challenges to better support its development.",
       ManziniDescription: "Manzini, Eswatini's most populous city, is a crucial commercial and industrial center. The city is the country's main transportation and trade hub, facilitating exchanges with neighboring South Africa. Manzini attracts investments in manufacturing and services, but improvements in transportation infrastructure are needed to support its growth.",
       SitekiDescription: "Siteki, located in eastern Eswatini, is an important center for agriculture and livestock. Surrounded by fertile lands, the town is ideal for producing sugar and food crops. Siteki has significant potential for agro-industrial development, but investments in transportation infrastructure and farmer training are essential to maximize its yield.",
       LobambaDescription: "Lobamba, the cultural and spiritual capital of Eswatini, is home to the Parliament and the royal family. It is an important cultural center, attracting visitors for its historical sites and traditional events, such as the Umhlanga (Reed Dance). Lobamba has strong potential in cultural tourism, but further promotion and investment in tourism infrastructure are needed to fully benefit from it.",
       conclusionSuaziland: "These four strategic cities in Eswatini, with their complementary roles, contribute significantly to the country's economic development. Their economic diversity, strategic geographical positions, and investment opportunities make them essential growth engines. To realize their full potential, Eswatini must continue to invest in infrastructure and promote its cultural heritage, fostering harmonious and sustainable development.",
 
       // South Africa (Afrique du Sud)
       nomAfriqueDuSud: 'South Africa',
       descripAfriqueDuSud1: "South Africa, often called the 'Rainbow Nation,' is known for its cultural, linguistic, and geographical diversity. This richness is reflected in a vibrant heritage showcasing the coexistence of various ethnic groups. The country is famous for its thriving art scene, music, and traditional dances, embodying the creativity and resilience of its people.",
       descripAfriqueDuSud2: "Despite socio-economic challenges, South Africa continues to show resilience and commitment to sustainable development by investing in infrastructure, education, and living conditions.",
       advantageAfriqueDuSud: 'South Africa’s cities are vital for economic growth and development, each offering unique opportunities based on their geography, resources, and local industries. Here is an overview of key cities and their economic potential:',
       JohannesburgDescription: "Johannesburg, the largest city and economic powerhouse, is a major financial and commercial center. Known as the 'City of Gold,' it has a vibrant economy driven by industries like mining, finance, and technology.",
       DurbanDescription: "Durban, located on the Indian Ocean, is one of the busiest ports in Africa and a significant industrial center, particularly in petrochemicals, sugar, and shipping industries.",
       CapeTownDescription: "Cape Town, famous for its natural beauty and heritage, is a key center for tourism, agriculture, and creative industries. Its port also plays an important role in international trade.",
       PretoriaDescription: "Pretoria, the administrative capital, is home to government institutions and has a strong presence in the education, defense, and technology sectors.",
       conclusionAfriqueDuSud: "South Africa’s cities, with their diverse economic strengths and geographical advantages, drive the country's development. Continued investment in infrastructure, education, and innovation is key to harnessing each city’s potential for sustainable growth.",

        // Comoros (translated content)
      nomComore: 'Comoros',
      descripComore1: "Comoros, often called the Perfumed Islands, is an archipelago located in the Indian Ocean between Madagascar and the African mainland. Known for its biodiversity, unique culture, and breathtaking landscapes, this archipelago stands out for its ancient traditions and exceptional natural heritage.",
      descripComore2: "Despite socio-economic and political challenges, Comoros shows notable resilience. The Comorian people are committed to preserving their heritage while aspiring to sustainable development that values both nature and culture.",
      advantageComore: "Comoros, with its strategic geographical location, offers interesting opportunities in various economic sectors. Here’s an overview of three key islands in the archipelago and their unique economic and development potential.",
      GrandeComoreDescription: "Grande Comore, the largest island, is the economic and administrative heart of the archipelago. The city of Moroni, the national capital, hosts Hahaya International Airport, facilitating exchanges with the outside world. The island is rich in natural resources, including vanilla, ylang-ylang, and other spices, which present significant opportunities for agriculture and export. However, efforts are needed to improve infrastructure, particularly in transportation and healthcare.",
      MoheliDescription: "Mohéli, one of the smallest islands in the archipelago, is known for its marine biodiversity and preserved landscapes. The Mohéli Marine Park, which attracts divers and nature lovers, represents a significant potential for sustainable tourism. Developing eco-friendly tourism infrastructure could boost the local economy and preserve the island’s natural resources.",
      AnjouanDescription: "Anjouan, known for its lush hills and plantations, is the agricultural center of Comoros. The island produces crops such as coffee, cocoa, and citrus fruits, which are essential for the local economy. With efforts to modernize agricultural techniques and improve market access, Anjouan could strengthen its contribution to the national economy while supporting food security.",
      conclusionComore: "Comoros, with its unique islands and diverse assets, plays an important role in the Indian Ocean's economic dynamics. Its cultural wealth, natural resources, and tourism potential offer growth opportunities. To maximize these opportunities, it’s crucial for Comoros to invest in infrastructure, strengthen local capacities, and promote effective governance. This will enable sustainable development while preserving the archipelago’s cultural identity and natural wealth.",

      // Madagascar (translated content)
      nomMadagascar: 'Madagascar',
      descripMadagascar1: "Madagascar, the fourth largest island in the world, is famous for its exceptional biodiversity, much of which is endemic. Known as the 'Island Continent,' it stands out for its variety of ecosystems, ranging from lush tropical forests to spiny deserts. In addition to its unique environment, Madagascar also has vast natural resources and economic potential in sectors such as agriculture, tourism, and mining.",
      descripMadagascar2: "The island faces economic and social challenges, but ongoing reforms and initiatives to develop sustainable infrastructure contribute to its growing dynamism. By focusing on agriculture, fishing, and ecotourism, Madagascar aims to promote balanced and environmentally-friendly economic growth.",
      advantageMadagascar: "Madagascar, with its vast natural resources and strategic location in the Indian Ocean, is a prime destination for investors and travelers. Here’s an overview of four strategic cities in Madagascar and their unique economic and development opportunities.",
      AntananarivoDescription: "Antananarivo, often referred to as 'Tana,' is the political, economic, and cultural capital of Madagascar. Located in the central highlands, the city is the country’s main business hub, with an economy largely focused on trade, public administration, and services. The textile industry and the production of vanilla and coffee are also economic drivers.",
      ToamasinaDescription: "Toamasina, on Madagascar’s east coast, is the nation’s main port and one of its most dynamic economic centers. Thanks to its deep-water port, Toamasina plays a key role in international trade, facilitating the export of Madagascar's mining, agricultural, and industrial products.",
      MahajangaDescription: "Mahajanga, located on the northwest coast, is an important port and tourist center. Situated on the Mozambique Channel, Mahajanga is strategically positioned for fishing and maritime trade activities. The local economy relies on fishing, agriculture, and tourism.",
      AntsirananaDescription: "Antsiranana, located at the extreme north of the island, is known for its natural harbor, one of the largest in the world, and its spectacular landscapes. Historically a strategic military center, Antsiranana is now a hub for maritime trade and a growing tourism center.",
      conclusionMadagascar: "Antananarivo, Toamasina, Mahajanga, and Antsiranana are key economic drivers for Madagascar, each offering specific assets that contribute to the country's growth. Sectors such as agriculture, mining, fishing, and tourism support the Malagasy economy.",

      // British Columbia
      nomColombieBritannique: 'British Columbia',
      descripColombieBritannique1: "British Columbia, located on the western edge of Canada, is a province known for its spectacular landscapes, ranging from majestic mountains to vast coastal rainforests. Its natural diversity is also reflected in its population, rich in Indigenous and multicultural influences. British Columbia serves as a bridge between North America and the Asia-Pacific, making it a key player in international trade.",
      descripColombieBritannique2: "Despite challenges related to urbanization and the protection of its unique environment, the province continues to thrive with a diversified and rapidly growing economy. British Columbia is increasingly focusing on sustainable development, with initiatives aimed at reducing its carbon footprint while promoting technological innovation.",
      advantageColombieBritannique: "As a coastal province, British Columbia benefits from a strategic position for trade and investments. Here is an overview of four strategic cities in British Columbia and their unique economic and development opportunities.",
      VancouverDescription: "Vancouver, the largest city in British Columbia, is the economic heart of the province. The city is home to one of North America's largest ports, Port of Vancouver, connecting Canada to global markets, especially those in the Asia-Pacific region. It is also a rapidly expanding technology hub, attracting companies in information technology, digital media, and green industries.",
      VictoriaDescription: "Victoria, the capital of British Columbia, located on Vancouver Island, is known for its natural beauty and rich historical heritage. The city plays a key role in the tourism sector, with millions of visitors each year. Victoria is also home to government institutions, offering opportunities in public administration and education.",
      KelownaDescription: "Kelowna, located in the Okanagan Valley, is a growing city known for its wine industry and tourism. The region's vineyards and orchards attract tourists and investors, making agriculture and tourism two economic pillars of the city.",
      PrinceGeorgeDescription: "Prince George is a key city in northern British Columbia, often described as the gateway to the province's natural resources. Its economy is primarily based on forestry, mining, and energy industries, making it a central hub for resource extraction.",
      conclusionColombieBritannique: "The four strategic cities of British Columbia are essential drivers for the province's development. Vancouver, Victoria, Kelowna, and Prince George offer unique opportunities in sectors ranging from technology and tourism to natural resource extraction.",

      // Alberta
      nomAlberta: 'Alberta',
      descripAlberta1: "Alberta, a province in western Canada, is known for its vast plains, towering mountains, and rich natural resources, including oil and gas. While its economy has historically relied on resource extraction, Alberta is working to diversify its industries to become a hub in agriculture, technology, and renewable energy.",
      descripAlberta2: "This province offers a business-friendly environment with a high quality of life and an innovative spirit. Environmental sustainability and energy transition challenges are central to Alberta's efforts to build a greener future while maintaining its position as an economic leader in Canada.",
      advantageAlberta: "Alberta plays a key role in Canada's economy due to its natural resources and geographical position. Here is an overview of four strategic cities in Alberta and their economic and development strengths.",
      CalgaryDescription: "Calgary is Alberta's largest city and the economic center of the province. Known as a global hub for the energy industry, it hosts many companies in oil, gas, and financial services. Recently, Calgary has diversified into industries such as technology, finance, and aerospace.",
      EdmontonDescription: "Edmonton, Alberta's capital, is known for its cultural festivals and role as a government and educational center. Edmonton's economy is primarily based on the public sector, academic research, as well as retail and healthcare.",
      RedDeerDescription: "Red Deer, located between Calgary and Edmonton, is a growing city with an economy based on agriculture, industry, and services. It has a strategic location for transportation and logistics, making it a key transit point for businesses.",
      FortMcMurrayDescription: "Fort McMurray, in northern Alberta, is known for being the heart of Canada's oil sands. This industrial center is essential for oil extraction, making it a major player in the province's economy.",
      conclusionAlberta: "Calgary, Edmonton, Red Deer, and Fort McMurray each play a critical role in Alberta's development. Their importance to the energy and natural resource industries, along with emerging sectors like technology, is essential to the provincial economy.",

      // Prince Edward Island
      nomIleDuPrinceEdouard: 'Prince Edward Island',
      descripIleDuPrinceEdouard1: "Prince Edward Island (P.E.I.), Canada’s smallest province in both area and population, is known for its scenic coastal landscapes, fertile farmland, and rich cultural heritage. With an economy historically based on agriculture, fishing, and tourism, P.E.I. continues to diversify its economic sectors.",
      descripIleDuPrinceEdouard2: "Although it faces challenges related to its geographical isolation and the protection of its vulnerable coastlines in the face of climate change, the island has managed stable growth and is a key player in agriculture, particularly potato production.",
      advantageIleDuPrinceEdouard: "Prince Edward Island, though small, offers a range of economic and strategic opportunities. Here is an overview of four strategic cities on Prince Edward Island and their unique development and economic opportunities.",
      CharlottetownDescription: "Charlottetown, the capital of P.E.I., is often called the 'Birthplace of Confederation' for its role in the founding of Canada. The city is also a cultural center with festivals, museums, and theaters.",
      SummersideDescription: "Summerside, the island's second-largest city, is a hub for aerospace, information technology, and financial services sectors. Summerside also supports renewable energy, especially wind energy.",
      SourisDescription: "Souris is a small port town that plays a critical role in maritime transport and fishing. It is a key entry point for ferries connecting P.E.I. to the Magdalen Islands in Quebec.",
      MontagueDescription: "Montague is a regional center for surrounding rural communities. Its economy is based on agriculture, especially potato and seafood production.",
      conclusionIleDuPrinceEdouard: "Charlottetown, Summerside, Souris, and Montague contribute to the prosperity of the province. Their economic diversity, combined with exceptional natural beauty, makes P.E.I. a place where tradition and innovation coexist.",

      // Manitoba
      nomManitoba: 'Manitoba',
      descripManitoba1: "Located in the heart of Canada, Manitoba is a vast and diverse province with an economy deeply rooted in agriculture, natural resources, and industry. Its varied landscapes, from fertile plains to boreal forests, offer abundant natural resources and a setting for tourism.",
      descripManitoba2: "Although Manitoba's economy has historically relied on agriculture, the province is working to diversify with investments in manufacturing, information technology, and renewable energy.",
      advantageManitoba: "With its vast natural resources and strategic location, Manitoba offers numerous economic opportunities. Here is an overview of four strategic cities in Manitoba and their unique economic and development potential.",
      WinnipegDescription: "Winnipeg, the capital and largest city of Manitoba, is the economic heart of the province. Historically a transportation and trade center due to its central location, Winnipeg has a diversified economy.",
      BrandonDescription: "Brandon, known as the breadbasket of Manitoba, relies heavily on agriculture. Located in a rich agricultural region, Brandon is a center for food processing and agricultural production.",
      ThompsonDescription: "Thompson, located in northern Manitoba, is often called the Nickel Capital of Canada due to its importance in the mining industry.",
      PortageLaPrairieDescription: "Portage la Prairie, located west of Winnipeg, is a growing center for agriculture and food processing. The city attracts industrial investments, especially in food processing.",
      conclusionManitoba: "Winnipeg, Brandon, Thompson, and Portage la Prairie are key growth drivers for Manitoba. With a balance between traditional sectors like agriculture and emerging sectors such as technology, Manitoba is well-positioned for sustainable growth.",


     // British Columbia
  nomBritishColumbia: 'British Columbia',
  descripBritishColumbia1: "British Columbia, located on Canada's western edge, is known for its dramatic landscapes, stretching from towering mountains to expansive coastal rainforests and stunning beaches. This natural diversity is reflected in its population, rich in Indigenous heritage and multicultural influences, making it a vibrant cultural hub. British Columbia serves as a bridge between North America and the Asia-Pacific region, establishing it as a key player in international trade, especially through its modern transportation infrastructure and openness to global markets.",
  descripBritishColumbia2: "Although the province faces challenges related to rapid urbanization and environmental protection, it continues to thrive with a diversified and rapidly growing economy focused on tourism, technology, and green industries. British Columbia increasingly emphasizes sustainable development, with initiatives aimed at reducing its carbon footprint and promoting technological innovation, especially in renewable energy and responsible resource management.",
  advantageBritishColumbia: "As a coastal province, British Columbia enjoys a strategic position for trade and investment, attracting businesses and talent from around the world. Here is an overview of four strategic cities in British Columbia and their unique economic development opportunities.",
  VancouverDescription: "Vancouver, British Columbia’s largest city, is the economic heart of the province and one of Canada’s most dynamic urban centers. The city is home to one of North America’s largest ports, the Port of Vancouver, which connects Canada to global markets, particularly in the Asia-Pacific. Vancouver is also a rapidly expanding technology hub, attracting companies in information technology, digital media, and green industries. The city boasts a cosmopolitan and multicultural community with a significant international presence that contributes to its cultural and economic vibrancy.",
  VictoriaDescription: "Victoria, the capital of British Columbia, located on Vancouver Island, is renowned for its exceptional natural beauty and rich historical heritage. The city plays a central role in the tourism industry, welcoming millions of visitors each year to its gardens, museums, and historic landmarks. As the seat of the provincial government, Victoria is a major hub for public institutions, administration, and education. The city is increasingly recognized for its sustainability initiatives and ecological innovations.",
  KelownaDescription: "Kelowna, in the picturesque Okanagan Valley, is a growing city known for its wine industry and tourism appeal. The region’s vineyards and orchards attract tourists and investors globally. While agriculture and tourism are economic pillars of Kelowna, the city is also diversifying into clean technology and renewable energy sectors, further enhancing its economic profile.",
  PrinceGeorgeDescription: "Prince George is a key city in northern British Columbia, often described as the gateway to the province’s natural resources. Its economy is primarily based on forestry, mining, and energy, positioning Prince George as a central hub for resource extraction and management. The city actively seeks to diversify its economy by attracting investments in renewable energy and advanced technology sectors.",
  conclusionBritishColumbia: "The four strategic cities of British Columbia—Vancouver, Victoria, Kelowna, and Prince George—are essential drivers of the province’s development. Each of these cities contributes uniquely to British Columbia’s diversified economy, offering opportunities across sectors from technology and tourism to natural resource extraction and international trade.",

  // Alberta
  nomAlberta: 'Alberta',
  descripAlberta1: "Alberta, a prominent province in western Canada, is recognized for its vast plains, majestic mountains, and rich natural resources, including oil, gas, and minerals. While historically reliant on resource extraction, Alberta is now diversifying its industries to include agriculture, technology, and renewable energy to build a more resilient and sustainable economy.",
  descripAlberta2: "The province offers a business-friendly environment with a high quality of life and an innovative spirit. Environmental sustainability and energy transition challenges are central to Alberta's efforts to build a greener future while retaining its role as an economic leader in Canada. The province invests in green infrastructure and technological solutions for its traditional industries, ensuring adaptation to contemporary environmental standards.",
  advantageAlberta: "Alberta plays a key role in the Canadian economy due to its abundant natural resources and its central geographical location for internal trade. Here is an overview of four strategic cities in Alberta and their economic and developmental strengths.",
  ...
  EdmontonDescription: "Edmonton, the capital of Alberta, is celebrated for its vibrant cultural scene, with festivals that draw visitors from around the world. As an administrative center, it houses the province's main government institutions and is a key center for education and research, with several universities and leading research institutions.",
  RedDeerDescription: "Red Deer, located between Calgary and Edmonton, is a growing city whose economy is based on agriculture, industry, and services. Benefiting from a strategic location, Red Deer aims to expand its industrial and technological sectors to meet regional economic needs.",
  FortMcMurrayDescription: "Fort McMurray, in northern Alberta, is globally recognized as the heart of Canada’s oil sands. The city plays a vital role in resource extraction and remains a driving force in the Canadian economy despite environmental challenges associated with these resources.",
  conclusionAlberta: "Calgary, Edmonton, Red Deer, and Fort McMurray are critical economic engines for Alberta, each making a unique contribution. The province continues to explore new avenues for sustainable growth, leveraging innovation, industrial diversity, and a commitment to environmental stewardship.",

  // Nova Scotia
  nomNovaScotia: 'Nova Scotia',
  descripNovaScotia1: "Nova Scotia, one of Canada’s Maritime provinces, is known for its breathtaking coastal landscapes, vibrant communities, and rich historical heritage. A blend of urban and rural, this province is an important economic center for Canada, with key industries like fishing, shipbuilding, and, more recently, information technology and services.",
  descripNovaScotia2: "As the Atlantic gateway, Nova Scotia benefits from a strategic position for international trade. Its port in Halifax, one of North America’s largest deep-water ports, connects it to global markets and supports a diversified economy.",
  advantageNovaScotia: "With its unique location and maritime resources, Nova Scotia offers diverse economic opportunities. Here’s an overview of four strategic cities in Nova Scotia.",
  ...
  SydneyDescription: "Sydney, located on Cape Breton Island, was historically a center for coal and steel industries. Today, it focuses on tourism, with the iconic Cabot Trail nearby, and renewable energy, especially wind energy projects.",
  TruroDescription: "Truro, often called the Hub of Nova Scotia, is strategically located for transport and logistics. The city also plays a significant role in agriculture and food processing.",
  LunenburgDescription: "Lunenburg, a UNESCO World Heritage site, is known for its maritime heritage and serves as a center for shipbuilding and fishing. Cultural tourism plays a major role in its economy.",
  conclusionNovaScotia: "Halifax, Sydney, Truro, and Lunenburg all contribute to Nova Scotia’s prosperity. Their diversified economies support the province’s quest for sustainable growth and economic development.",

  // Quebec
  nomQuebec: 'Quebec',
  descripQuebec1: "Quebec, Canada’s largest province by area, is distinguished by its cultural diversity, natural wealth, and leadership in several industries, including aerospace, information technology, and agri-food. Quebec’s French-speaking heritage adds a unique dimension to its cultural identity.",
  descripQuebec2: "Economically, Quebec is vital to Canada. The province leads in renewable energy, particularly hydroelectricity, and continues to diversify its economy while promoting sustainable development and innovation.",
  advantageQuebec: "With abundant natural resources, a diversified economy, and a distinct culture, Quebec offers unique economic opportunities.",
  MontrealDescription: "Montreal, Quebec’s economic and cultural hub, is a center for creative industries, IT, and academic research. Its vibrant cultural scene and diversity attract talent from around the world.",
  QuebecCityDescription: "Quebec City, the provincial capital, is known for its rich heritage and role as an administrative center. It is expanding in sectors like life sciences and tourism.",
  SherbrookeDescription: "Sherbrooke is a major university and industrial center. The city focuses on health research, clean technologies, and advanced materials.",
  TroisRivieresDescription: "Trois-Rivières, with its paper and forestry industries, is a key industrial center, especially for trade along the St. Lawrence River.",
  conclusionQuebec: "Montreal, Quebec City, Sherbrooke, and Trois-Rivières are economic pillars for Quebec, integrating tradition and innovation across various sectors.",

  // Saskatchewan
  nomSaskatchewan: 'Saskatchewan',
  descripSaskatchewan1: "Saskatchewan, located in the Canadian Prairies, is best known for its vast agricultural lands and rich natural resources, particularly wheat, uranium, and potash.",
  descripSaskatchewan2: "Although largely rural, Saskatchewan is experiencing growth in its urban centers, attracting investments in clean technology, scientific research, and green industries.",
  advantageSaskatchewan: "With its natural resources and agricultural expertise, Saskatchewan meets global needs in food, energy, and minerals.",
  SaskatoonDescription: "Saskatoon, a growing economic and academic center, focuses on agriculture, biotechnology, and innovation.",
  ReginaDescription: "Regina, the provincial capital, is a center for energy and technology.",
  PrinceAlbertDescription: "Prince Albert, on the edge of the boreal forest, is a hub for forestry and mining industries.",
  MooseJawDescription: "Moose Jaw is a center for agriculture, food processing, and military industry.",
  conclusionSaskatchewan: "Saskatoon, Regina, Prince Albert, and Moose Jaw drive Saskatchewan’s economy, supporting an evolving agricultural and industrial landscape.",

  // Newfoundland and Labrador
  nomNewfoundlandLabrador: 'Newfoundland and Labrador',
  descripNewfoundlandLabrador1: "Newfoundland and Labrador, Canada’s easternmost province, is known for its breathtaking landscapes and rich maritime heritage.",
  descripNewfoundlandLabrador2: "The economy is largely based on fishing, offshore oil, and mining industries, which dominate the economic landscape.",
  advantageNewfoundlandLabrador: "With its natural and maritime resources, Newfoundland and Labrador is essential to Atlantic Canada’s economy.",
  StJohnsDescription: "St. John’s, the provincial capital, is the economic and cultural center, known for its unique architectural heritage.",
  CornerBrookDescription: "Corner Brook is an industrial center for papermaking and a gateway for tourism to Gros Morne National Park.",
  LabradorCityDescription: "Labrador City, at the heart of the mining industry, is a major producer of iron ore.",
  HappyValleyGooseBayDescription: "Happy Valley-Goose Bay, with its airbase, is a key hub for defense and logistics.",
  conclusionNewfoundlandLabrador: "The cities of Newfoundland and Labrador, especially St. John’s, Corner Brook, Labrador City, and Happy Valley-Goose Bay, are vital to the provincial economy, blending tradition and modernity.",


      // Home Component Events Data
        event1_title: 'Sustainable Construction and Wood Transformation Expo',
        event1_desc: 'An international event connecting key players in the construction and wood transformation sectors from Canada and various African countries.',
        event2_title: 'Francophone Municipalities Forum',
        event2_desc: 'A collaborative forum addressing workforce and economic challenges between Quebec and African municipalities.',
        event3_title: 'International Coffee Expo',
        event3_desc: 'A unique platform to promote African coffee and connect with Canadian distributors and roasters.',
        event4_title: 'Executive and Entrepreneur Capacity Development Program',
        event4_desc: 'A program in partnership with Canadian universities offering executive training for African leaders and entrepreneurs.',

        // Home Component Activities Data
        activity1_title: 'Commercial Exchange Platform',
        activity1_desc: 'Creating a digital platform connecting Canadian and African businesses.',
        activity2_title: 'Webinars and Training Workshops',
        activity2_desc: 'Organizing webinars on topics such as market entry and business culture.',
        activity3_title: 'Trade Missions',
        activity3_desc: 'Regular trade missions in both Canada and Africa to connect businesses and explore new markets.',

        // Presentations Component
        presentationDescription: "The Canada Africa Chamber of Commerce is an organization tasked with representing the interests of commercial, industrial, and service-oriented businesses, ensuring entrepreneurial training, and providing business support. It represents professionals in the trade, industry, and service sectors to local and international public authorities within its mission domains. The CCCA undertakes representative, consultative, support, and promotional missions.",
        ...
        servicesData: [
          {
            ...
            description: "The CCCA offers a full range of services for business startups in Canada. Through its network of entrepreneurship experts in Canada, CCCA members can request our services to support them in starting and growing their businesses in Canada or in an African country where it is represented.",
          },
          {
            title: 'Francophonie',
            description: 'The CCCA is primarily a Francophone economic market that connects Canadian and African Francophone communities. It then opens up to Anglophone economies to encourage business dynamics driven by the desire to trade in the French language.',
          },
          {
            title: 'Business Acquisition',
            description: 'The CCCA is dedicated to attracting investors and entrepreneurs based in Africa who wish to acquire a business in general and particularly in Quebec.',
          },
          {
            title: 'International Cooperation',
            description: "The CCCA brings together expertise to conduct trade missions in both Canada and Africa.",
          },
          {
            title: 'Business Networking',
            description: 'The CCCA offers a business networking program through exhibitions, forums, and fairs organized in the form of B-to-B and B-to-C meetings.',
          },
          {
            title: 'Training',
            description: 'This training program is provided by business development experts based in both Canada and Africa.',
          },
          {
            title: 'Incubations',
            description: 'Through its "CCCA-Propuls" incubation and acceleration program, the CCCA supports Canada-based entrepreneurs from ideation to business launch.',
          }
        ],
        ...
        newsletter_benefit1: 'Never miss profitable activities for your organization',
        newsletter_benefit2: 'Receive the latest news directly by email',
        newsletter_benefit3: 'Stay at the heart of the metropolis\'s economic activity',
        newsletter_benefit4: 'Don\'t miss out on blog updates',
        newsletter_placeholder: 'Enter your email',
        newsletter_subscribe: 'Subscribe',
        newsletter_error: 'Please enter a valid email address.',
        newsletter_success: 'Thank you for subscribing to our newsletter with the address: {{email}}',
      

        // Event Titles and Descriptions
        event_title1: 'Sustainable Construction and Wood Transformation Expo: A Bridge Between Canada and Africa',
        event_description1: 'The Sustainable Construction and Wood Transformation Expo, scheduled for November 2025, will be a major international event...',
        event_title2: 'Quebec Francophone Municipalities Forum (SAMUQAF)',
        event_description2: 'The Quebec Francophone Municipalities Forum (SAMUQAF) brings together communities...',
        event_title3: 'International Coffee Expo (SICAF)',
        event_description3: 'The International Coffee Expo (SICAF) is a unique event dedicated to promoting African coffee...',
        event_title4: 'Executive and Entrepreneur Capacity Development Program (PPCDE)',
        event_description4: 'The Executive and Entrepreneur Capacity Development Program offers training...',
        
        // Section Titles and Descriptions
        objectives_title: 'Objectives of the Expo',
        objectives_intro: 'The Expo aims to:',
        objective1: 'Promote sustainable building practices through technological innovations and eco-friendly materials.',
        objective2: 'Encourage exchanges between professionals from Canada and African countries.',
        objective3: 'Facilitate commercial partnerships between Canada and African countries rich in forest resources.',

        why_participate: 'Why Participate?',
        why_participate_intro: 'The Expo aims to:',
        business_opportunity: 'Business Opportunities: A platform for strong commercial relations...',
        exchange_professionals: 'Promote exchanges between wood industry professionals, architects, and policymakers...',
        tech_partnerships: 'Encourage technological partnerships for joint projects.',

        location_quebec: 'Quebec',

        // Navbar Africa Offices Data
        africaOfficesData: [
          { title: 'Central Africa', countries: ['Cameroon', 'Angola', 'Congo', 'Chad', 'Gabon', 'São Tomé and Príncipe', 'Equatorial Guinea', 'Central African Republic'] },
          { title: 'West Africa', countries: ['Nigeria', 'Burkina Faso', 'Cape Verde', "Côte d'Ivoire", 'Gambia', 'Ghana', 'Guinea', 'Guinea-Bissau', 'Liberia', 'Mali'] },
          { title: 'East Africa', countries: ['Burundi', 'Kenya', 'Djibouti', 'Malawi', 'Mauritius', 'Mozambique', 'Rwanda', 'Uganda', 'Zambia'] },
          { title: 'North Africa', countries: ['Algeria', 'Egypt', 'Libya', 'Morocco', 'Mauritania', 'Sudan', 'Tunisia'] },
          { title: 'Southern Africa', countries: ['Botswana', 'Lesotho', 'Namibia', 'Eswatini', 'South Africa'] },
          { title: 'Indian Ocean', countries: ['Comoros', 'Madagascar'] },
        ],

        // Navbar Canada Representation Data
        canadaRepresentationData: ['Alberta', 'British Columbia', 'Prince Edward Island', 'Manitoba', 'Nova Scotia', 'Quebec', 'Saskatchewan', 'Newfoundland and Labrador'],
        // Objectif Component
        emerging_markets_access: 'Access to Emerging Markets',
        emerging_markets_access_desc: 'Canadian small and medium enterprises (SMEs) have unique opportunities to enter African markets, which are often less competitive and more open to innovation. Niche sectors, such as green technologies or sustainable agriculture, offer specific opportunities for SMEs.',
        support_programs: 'Support Programs',
        support_programs_desc: 'Various Canadian programs exist to help SMEs explore and establish in African markets, including funding, mentoring, and logistical support.',
        ...
        mission_content: `While our name and reach evolve, our mission remains true to our core values. We aim to be an exceptional hub of economic solidarity and to foster enriching collaboration for business communities on both sides of the Atlantic. Under the enlightened leadership of Dr. Armand, the CCCA will continue to build economic bridges between Canada and Francophone Africa while welcoming new opportunities and Anglophone partners, thus promoting an inclusive and integrated approach.`,
         ...
         address: '400 - 257 Sherbrooke Street East, Montreal, H2X 1E3, QC, Canada',
         ...
         //Actualités
         news_title1: 'Interview with the President of the Canada Africa Chamber of Commerce on Jambo TV',
         news_description1: 'Creation of a digital platform that connects Canadian and African businesses. This platform could allow the sharing of information on products, services, investment opportunities and current projects.',
         news_title2: 'Brain drain: Africa loses talent to Canada',
         news_description2: 'Organizing webinars on key topics such as market entry, business culture, local legislation and sustainable business practices.',
         news_title3: 'Quebec stops recruiting nurses from Africa for "ethical" reasons',
         news_description3: 'Organization of regular trade missions, both in Canada and Africa, to allow companies to meet potential partners and discover local markets.',
         news_title4: 'Exploring opportunities for green hydrogen in Atlantic Canada',
         news_description4: 'Exploring the possibilities offered by the development of green hydrogen in Atlantic Canada, aimed at improving the energy transition and strengthening cooperation with African countries for clean energy.',
         ...
         event_description1: 'The Sustainable Construction and Wood Transformation Expo, scheduled for November 2025, will bring together...',
         event_title2: 'Quebec Francophone Municipalities Forum (SAMUQAF)',
         event_description2: 'Organized by the Quebec-Africa Chamber of Commerce to address critical workforce challenges in municipal enterprises...',
         event_title3: 'International Coffee Expo (SICAF)',
         event_description3: 'The International Coffee Expo, to be held in Canada for the first time, is a unique platform promoting African coffee...',
         event_title4: 'Executive and Entrepreneur Capacity Development Program (PPCDE)',
         event_description4: 'The PPCDE program offers executive training in collaboration with HEC Montreal, Laval University...',
         
         past_event_title1: 'Francophonie Business Meeting (RAF24)',
         past_event_description1: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
         past_event_title2: 'Francophonie Business Meeting (RAF24)',
         past_event_description2: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
      ...
      entrepreneurship_para_1: "The CCCA offers a full range of services for business startups in Canada. Through its network of entrepreneurship experts, CCCA members can seek our services to support them in starting and growing their businesses in Canada or an African country where we are represented.",
      entrepreneurship_para_2: "The CCCA relies on solid partnerships and Canadian entrepreneurship support organizations. We can suggest innovative business ideas, assist in creating entrepreneurial projects, business plans, strategic planning, and marketing communication strategies.",
      entrepreneurship_para_3: "Additionally, the CCCA's support service is structured through its integrated incubator, offering a comprehensive environment and essential tools to start a business, open a subsidiary, or revive a dormant business in Canada and Africa.",
      entrepreneurship_partners: "Our Partners",

      repreneurship_para: "The CCCA's mandate is to attract investors and business people based in Africa who wish to take over a business, especially in Quebec. The government of Quebec, through the Ministry of Economy, Innovation and Energy and the Ministry of Immigration, promotes repreneurship due to a lack of successors. Approximately 25% of business owners aged 65+ intend to close their businesses for this reason.",
      repreneurship_benefits: "Direct Benefits of Repreneurship",
      repreneurship_benefit_1: "Easier to secure financing due to existing financial history and assets.",
      repreneurship_benefit_2: "Established brand image and reputation.",
      repreneurship_benefit_3: "Products and services are well-aligned in a competitive market.",
      repreneurship_benefit_4: "Lower risk of bankruptcy as the business is already productive.",
      repreneurship_benefit_5: "Established client and supplier relationships.",
      repreneurship_benefit_6: "Skilled and experienced workforce.",
      repreneurship_benefit_7: "Previous management can assist in transitioning for optimal continuity.",

      francophonie_para_1: "The CCCA is primarily a Francophone economic network connecting Francophone communities in Canada and Africa. It then opens to Anglophone economies to foster business dynamics inspired by a desire to conduct business in French. Through Francophonie, the CCCA seeks to attract diverse economies within an ecosystem fostered by the French language.",
      francophonie_para_2: "The CCCA also offers French learning spaces for business purposes, providing a French-language program for any entrepreneur or investor settling in Quebec or Francophone communities in Canada.",

      international_cooperation_para: "The CCCA consolidates expertise for trade missions in both Canada and Africa. This service supports governments, public or para-public institutions, non-profits, and businesses aiming to conduct trade, prospecting, or exploratory missions to foster partnerships, business development, or representation opportunities.",

      business_networking_para_1: "The CCCA offers a business networking program through exhibitions, forums, and fairs organized as B2B and B2C meetings, allowing participants to form or finalize business alliances between Canada and Africa.",
      business_networking_para_2: "The CCCA collaborates with partner organizers to attract Canadian delegations of entrepreneurs and investors to participate in significant economic events in Africa, and conversely, mobilizes African delegations to participate in business events organized in Canada.",

      incubation_para: "Through its incubation and acceleration program, 'CCCA - Propuls,' the CCCA supports Canada-based entrepreneurs from ideation to business launch. With four tracks, CCCA - Propuls equips you with essential resources to start a business in Canada and see it to fruition.",

      training_para: "The CCCA provides a training program to support entrepreneurs based in Africa from ideation to business launch. With two major types of training, CCCA - Propuls offers essential resources to help start and realize a business in Canada.",

      // Programs, Partners, and Other Sections
      leadership_program_title: "Leadership and Entrepreneurship Capacity Development Program",
      leadership_program_description: "An in-depth program that connects with top universities to equip leaders with skills in various fields.",
      repreneurship_program_title: "Repreneurship Training Program",
      repreneurship_program_description: "Specialized training aimed at helping entrepreneurs take over existing businesses.",

      // University and Training Options
      ...
      university_laval_program_1: "University Certificate in Corporate Governance",
      ...
      news_title1: 'Interview with the President of the Canada Africa Chamber of Commerce on Jambo TV',
      news_description1: 'Creation of a digital platform that connects Canadian and African businesses. This platform allows for information sharing on products, services, investment opportunities, and ongoing projects.',
      news_title2: 'Brain Drain: Africa is Emptied in Favor of Canada',
      news_description2: 'Organization of webinars on key topics such as market entry, business culture, local legislation, and sustainable business practices.',
      news_title3: 'Quebec Stops Recruiting Nurses in Africa for "Ethical" Reasons',
      news_description3: 'Regular trade missions organized in Canada and Africa, allowing companies to meet potential partners and discover local markets.',
      news_title4: 'Exploring Green Hydrogen Opportunities in Atlantic Canada',
      news_description4: 'Exploring the opportunities offered by the development of green hydrogen in Atlantic Canada to enhance energy transition and strengthen cooperation with African countries for clean energy.',
    

        // Navbar Activities Data
        activitiesData: [
          {
            title: 'Commercial Exchange Platform',
            description: "Creation of a digital platform connecting Canadian and African businesses.",
          },
          {
            title: 'Webinars and Training Workshops',
            description: "Organization of webinars on key topics such as market entry and business culture.",
          },
          {
            title: 'Trade Missions',
            description: 'Regular trade missions in both Canada and Africa to enable companies to meet potential partners and explore local markets.',
          },
          {
            title: 'Trade Fairs and Professional Exhibitions',
            description: "Organizing or participating in trade fairs to showcase companies from both regions.",
          },
          {
            title: 'Mentorship Program',
            description: "Establishing a mentorship program linking established businesses with startups.",
          },
          {
          ...
          },
          {
            ...
            description: "Organizing an annual forum to discuss economic opportunities and challenges.",
          },
          {
            title: 'Publications and Educational Resources',
            description: "Creating reports, market studies, and practical guides.",
          },
          {
            title: 'Social Media and Communication',
            description: "Using social media to promote businesses and provide information.",
          },
          {
            title: 'Support for Francophonie',
            description: "Developing initiatives to promote exchanges within the Francophonie.",
          }
        ]
      },
    },
    ...
    fr: {
      ...
      //pays_BureauxAF
        ...
        // Cameroon descriptions
        descrip1: 'Le Cameroun, souvent appelé "l’Afrique en miniature", est un pays situé en Afrique centrale, connu pour sa diversité culturelle, linguistique et géographique. Cette diversité enrichit son patrimoine et reflète la coexistence harmonieuse de plusieurs groupes ethniques. Le Cameroun est également renommé pour sa scène artistique riche, sa musique vibrante et ses danses traditionnelles, illustrant l’esprit et la créativité de son peuple.',
        descrip2: 'Malgré les défis socio-économiques et politiques auxquels il fait face, le Cameroun continue de faire preuve d’une résilience remarquable. Les Camerounais sont engagés à construire un avenir meilleur, avec un accent sur le développement durable et l’amélioration de la qualité de vie.',
        advdescript1: 'Le Cameroun est un pays d’Afrique centrale doté d’une diversité géographique, culturelle et économique qui en fait un acteur stratégique de la région. Il est composé de plusieurs villes-clés, chacune jouant un rôle particulier dans le développement économique et social du pays. Voici un aperçu de quatre villes stratégiques du Cameroun et leurs spécificités en matière d’opportunités économiques et de développement.',

        // Cameroon city descriptions
        DescripDla: 'Douala est la capitale économique du Cameroun, abritant le port le plus actif de la région et un centre industriel vital. La ville joue un rôle crucial dans le commerce national et international, attirant des investissements dans de nombreux secteurs, notamment l’énergie et les services. Cependant, la ville est confrontée à des défis d’infrastructures qui limitent son potentiel.',
        DescripYnde: 'Yaoundé, la capitale politique du Cameroun, est le centre administratif du pays. La ville abrite des institutions gouvernementales et de nombreux organismes internationaux. Yaoundé est également un centre universitaire, avec de nombreuses universités et instituts de recherche, ce qui en fait un pôle de connaissances et de formation.',
        DescripGra: 'Garoua, située dans le nord du Cameroun, est connue pour son rôle dans l’agriculture et l’élevage. La ville est un centre économique important pour la production de coton, de bétail et d’autres cultures. Garoua a un potentiel significatif pour le développement agro-industriel, mais des investissements sont nécessaires pour soutenir sa croissance.',
        DescripBmda: 'Bamenda, située dans la région du Nord-Ouest, est connue pour son dynamisme culturel et ses paysages montagneux. La ville est un centre commercial pour la région anglophone du Cameroun et joue un rôle important dans le commerce transfrontalier avec le Nigeria voisin.',
        ConcCmr: 'Ces quatre villes stratégiques du Cameroun, avec leurs rôles complémentaires, contribuent de manière significative au développement économique du pays. Pour réaliser leur plein potentiel, le Cameroun doit continuer à investir dans les infrastructures et à améliorer la gouvernance locale pour un développement durable et harmonieux.',

        // Angola descriptions
        descripAngola1: "L'Angola, souvent appelée le pays des ressources, est un pays situé en Afrique australe, reconnu pour sa diversité culturelle, linguistique et géographique.Cette richesse se manifeste à travers un patrimoine unique, reflétant la coexistence de plusieurs groupes ethniques, dont les Ovimbundu, les Kimbundu et les Bakongo.L'Angola est également célèbre pour sa scène artistique dynamique, sa musique envoûtante, comme le kuduro et le semba, et ses danses traditionnelles qui illustrent l'esprit créatif de son peuple.",
        descripAngola2: "Malgré les défis socio-économiques et politiques auxquels il a été confronté, l'Angola montre une résilience impressionnante.Les Angolais s'engagent activement dans la construction d'un avenir meilleur, avec un accent sur le développement durable et l'amélioration de la qualité de vie. Le pays, riche en ressources naturelles comme le pétrole et les diamants, aspire à diversifier son économie et à réduire sa dépendance aux hydrocarbures.",
        advdescriptAngola1: "L'Angola est un pays doté d'une diversité géographique et économique qui en fait un acteur stratégique en Afrique. Il est composé de plusieurs villes-clés, chacune jouant un rôle spécifique dans le développement économique et social du pays. Voici un aperçu de quatre villes stratégiques de l'Angola et leurs particularités en matière d'opportunités économiques et de développement.",
    ...
    advantageSaoTome: "Sao Tomé-et-Principe, avec sa diversité naturelle et culturelle, joue un rôle stratégique dans le golfe de Guinée. Le pays est composé de deux îles principales et plusieurs localités dynamiques, chacune ayant un rôle spécifique dans le développement économique et social du pays. Voici un aperçu de quatre localités clés de Sao Tomé-et-Principe et leurs particularités en matière d'opportunités économiques et de développement.",
    DescripSaoTome: "Sao Tomé, la capitale et plus grande ville, est le centre politique, économique et culturel du pays. Elle abrite les principales institutions gouvernementales, entreprises, et services. Sao Tomé est un point d'entrée majeur pour le tourisme, grâce à ses plages et à son architecture coloniale. Cependant, la ville fait face à des défis liés aux infrastructures et à la gestion urbaine, limitant son développement optimal.",
    DescripSantoAntonio: "Santo António, située sur l'île de Principe, est la capitale de cette région autonome et joue un rôle central dans le développement du tourisme haut de gamme et durable. L'île de Principe, classée réserve de biosphère par l’UNESCO, attire les amateurs de nature et d’écotourisme. Pour exploiter pleinement son potentiel touristique, Santo António nécessite des investissements pour améliorer les infrastructures d'accueil et promouvoir des pratiques de tourisme durable.",
    DescripGuadalupe: "Guadalupe, située sur la côte nord de l’île de Sao Tomé, est un centre important pour la culture du cacao et des épices, comme le poivre. La ville bénéficie de terres fertiles et d'un climat favorable à l’agriculture, ce qui en fait un pilier de la production agricole nationale. Pour maximiser sa production, des investissements dans les infrastructures agricoles et la modernisation des méthodes de production sont nécessaires.",
    DescripTrindade: "Trindade, proche de la capitale Sao Tomé, est un centre agricole et un carrefour de transport. La ville joue un rôle crucial dans la distribution des produits agricoles vers la capitale et le port. Trindade a un potentiel pour le développement d’agro-industries, mais pour ce faire, des améliorations dans les infrastructures de transport et de stockage sont essentielles.",
    ConcSaoTome: "Ces quatre localités stratégiques de Sao Tomé-et-Principe, à travers leurs rôles complémentaires, contribuent de manière significative au développement économique du pays. Leur potentiel agricole, leurs paysages naturels préservés, et les opportunités dans le secteur touristique en font des moteurs de croissance prometteurs. Pour réaliser leur plein potentiel, Sao Tomé-et-Principe doit continuer à investir dans les infrastructures et à promouvoir le tourisme durable, favorisant ainsi un développement harmonieux et durable.",


    // Equatorial Guinea Translations
    GuineaEq: 'Guinée équatoriale',
    descripGuineaEq1: "La Guinée équatoriale, souvent appelée \"le joyau du golfe de Guinée\", est située en Afrique centrale et est reconnue pour sa diversité culturelle, linguistique et géographique. Cette richesse se manifeste à travers un patrimoine vivant, illustrant la coexistence de plusieurs groupes ethniques, dont les Fang, les Bubi, et les Ndowe. Le pays est également célèbre pour sa scène artistique dynamique, sa musique traditionnelle et ses danses qui témoignent de la créativité et de la résilience de son peuple.",
    descripGuineaEq2: "Malgré les défis socio-économiques et politiques auxquels elle fait face, la Guinée équatoriale continue de faire preuve d'une résilience remarquable. Les Équato-guinéens s'engagent activement dans la construction d'un avenir meilleur, avec un accent sur le développement durable et l'amélioration des conditions de vie. Riche en ressources naturelles, notamment le pétrole, le gaz et le bois, le pays cherche à diversifier son économie pour réduire sa dépendance à l'exportation de matières premières.",
    advantageGuineaEq: "La Guinée équatoriale est un pays aux multiples facettes, avec une diversité géographique et culturelle qui en fait un acteur clé dans le golfe de Guinée. Il est composé de plusieurs villes stratégiques, chacune jouant un rôle spécifique dans le développement économique et social du pays. Voici un aperçu de quatre villes clés de la Guinée équatoriale et leurs particularités en matière d'opportunités économiques et de développement.",
    DescripMalabo: "Malabo, la capitale située sur l'île de Bioko, est le cœur politique et administratif de la Guinée équatoriale. Elle abrite de nombreuses institutions gouvernementales, entreprises, et organisations internationales. La ville est un centre important pour l'industrie pétrolière, mais elle doit relever les défis liés aux infrastructures vieillissantes et à une urbanisation rapide pour attirer plus d'investissements.",
    DescripBata: "Bata, la plus grande ville continentale, est un centre économique vital pour la Guinée équatoriale. Elle joue un rôle clé dans le commerce et la pêche grâce à son port actif, facilitant les échanges avec les pays voisins. La ville est également un centre de distribution de produits pétroliers. Toutefois, Bata nécessite des améliorations en matière d'infrastructures pour répondre aux besoins de sa croissance urbaine et industrielle.",
    ...
    ConcGuineaEq: "Ces quatre villes stratégiques de la Guinée équatoriale, à travers leurs rôles complémentaires, contribuent de manière significative au développement économique du pays. Leur diversité économique, leurs positions géographiques avantageuses et les opportunités d'investissement qu'elles offrent en font des moteurs de croissance essentiels. Pour réaliser leur plein potentiel, la Guinée équatoriale doit continuer à investir dans les infrastructures et à renforcer la gouvernance locale, favorisant ainsi un développement harmonieux et durable.",
    ...
    // Burkina Faso Translations
    BurkinaFaso: 'Burkina Faso',
    descripBurkinaFaso1: "Encore appelé « Le Pays des Hommes Honnêtes », est un pays enclavé situé en Afrique de l’Ouest. Ce surnom met en valeur les valeurs culturelles du pays et l’importance accordée à l’intégrité et à la conduite morale. Le Burkina Faso est également reconnu pour sa scène artistique et culturelle dynamique. La musique et la danse traditionnelles, comme les rythmes entraînants du tambour djembé et les mouvements gracieux des troupes de danse traditionnelle, font partie intégrante de la culture burkinabè. Le pays a produit des musiciens, cinéastes et artistes talentueux qui utilisent leurs expressions créatives pour refléter l’esprit et les aspirations du peuple burkinabè.",
    descripBurkinaFaso2: "Ces dernières années, le Burkina Faso a été confronté à des défis liés à la sécurité et au développement socio-économique. Cependant, le peuple burkinabè continue de faire preuve de résilience, de détermination et d’engagement à construire un avenir meilleur pour son pays.",
    advantageBurkinaFaso: "Le Burkina Faso est un pays doté de potentiels économiques diversifiés et ses villes jouent un rôle important dans le moteur de la croissance économique et du développement. Voici quelques-unes des villes clés du Burkina Faso et leurs potentiels économiques :",
    DescripOuagadougou: "En tant que capitale et plus grande ville du Burkina Faso, Ouagadougou constitue le centre administratif, économique et culturel du pays. Elle abrite des institutions gouvernementales, des organisations internationales et un secteur privé en pleine croissance.",
    ...
    DescripKoudougou: "La troisième plus grande ville du Burkina Faso est connue comme un centre d'éducation et de commerce. Elle abrite plusieurs universités et établissements de formation professionnelle, produisant une main-d’œuvre qualifiée. Le potentiel économique de Koudougou comprend l'agriculture, en particulier la production de cultures de rente comme le coton et les céréales.",
    DescripBanfora: "Située dans la région des Cascades du Burkina Faso, Banfora est connue pour sa productivité agricole et ses attraits naturels. La ville bénéficie de sols fertiles et d'un climat favorable aux cultures telles que la canne à sucre, les mangues et les noix de cajou.",
    ...
    ConcCoteDIvoire: "Ces quatre villes stratégiques de la Côte d'Ivoire, chacune avec ses atouts uniques, contribuent de manière significative au développement économique du pays. Leur diversité économique, leurs positions géographiques avantageuses et les opportunités d'investissement qu'elles offrent en font des moteurs de croissance essentiels. Pour réaliser leur plein potentiel, il est impératif que la Côte d'Ivoire investisse davantage dans les infrastructures et améliore la gouvernance locale, favorisant ainsi un développement harmonieux et durable.",
    ...
    ConcGhana: "Ces quatre villes stratégiques du Ghana, à travers leurs rôles complémentaires, contribuent de manière significative au développement économique du pays. Leur diversité économique, leurs positions géographiques avantageuses et les opportunités d'investissement qu'elles offrent en font des moteurs de croissance essentiels. Pour réaliser leur plein potentiel, le Ghana doit continuer à investir dans les infrastructures et à améliorer la gouvernance locale, favorisant ainsi un développement harmonieux et durable.",
        ...
        descripGuinea2: "Malgré les défis socio-économiques et politiques auxquels elle fait face, la Guinée montre une volonté de surmonter les obstacles pour construire un avenir meilleur, axé sur le développement durable et l'amélioration des conditions de vie. Riche en ressources naturelles, notamment la bauxite, l’or et le fer, la Guinée aspire à diversifier son économie et à réduire sa dépendance à l'exportation de matières premières.",
        advantageGuinea: "La Guinée est un pays aux multiples facettes, avec une diversité géographique et culturelle qui en fait un acteur clé en Afrique de l'Ouest. Voici un aperçu de quatre villes clés de la Guinée et leurs particularités en matière d'opportunités économiques et de développement.",
        DescripConakry: "Conakry, la capitale et plus grande ville de la Guinée, est le centre économique et politique du pays. Elle abrite de nombreuses institutions gouvernementales, entreprises et organisations internationales. En tant que principal port du pays, Conakry facilite les échanges commerciaux, mais la ville fait face à des défis d'infrastructures et à une urbanisation rapide, nécessitant des investissements pour soutenir son développement.",
        ...
        descripGuineaBissau2: "Malgré les défis socio-économiques et politiques auxquels elle fait face, la Guinée-Bissau continue de faire preuve d’une résilience remarquable. Les Bissau-Guinéens s'engagent activement dans la construction d'un avenir meilleur, avec un accent sur le développement durable et l'amélioration des conditions de vie. Le pays, riche en ressources naturelles comme la noix de cajou, le bois et les ressources halieutiques, aspire à diversifier son économie et à réduire sa dépendance à l'exportation de matières premières.",
        advantageGuineaBissau: "La Guinée-Bissau est un pays aux multiples facettes, avec une diversité géographique et culturelle qui en fait un acteur clé en Afrique de l'Ouest. Il est composé de plusieurs villes stratégiques, chacune jouant un rôle spécifique dans le développement économique et social du pays. Voici un aperçu de quatre villes clés de la Guinée-Bissau et leurs particularités en matière d'opportunités économiques et de développement.",
        DescripBissau: "Bissau, la capitale et plus grande ville du pays, est le cœur économique et politique de la Guinée-Bissau. Elle abrite de nombreuses institutions gouvernementales et organisations internationales. Bissau est un port important, facilitant les échanges commerciaux, en particulier pour les exportations de noix de cajou. Cependant, la ville doit relever des défis liés aux infrastructures et à la gestion urbaine pour soutenir son développement.",
        DescripBafata: "Bafatá, située à l'est de Bissau, est un centre agricole majeur. La ville est connue pour la culture de la noix de cajou et du riz, qui sont essentiels pour l'économie du pays. Bafatá a un potentiel de développement agro-industriel important, mais elle nécessite des investissements dans les infrastructures de transformation et de transport pour maximiser sa productivité et sa contribution à la sécurité alimentaire.",
        DescripGabu: "Gabú, située à l'est du pays, est une région vitale pour l’élevage et l’agriculture. La ville est un carrefour commercial pour les échanges avec le Sénégal et la Guinée. Gabú a un potentiel significatif pour le développement de l'agro-pastoralisme, mais des améliorations dans les infrastructures routières et l'accès aux marchés sont nécessaires pour stimuler sa croissance économique.",
    ...
    DescripNairobi: "Nairobi, la capitale et plus grande ville du Kenya, est le cœur économique et politique du pays. Elle abrite de nombreuses institutions gouvernementales, entreprises et organisations internationales. Nairobi est un hub régional pour les affaires et la technologie, avec un secteur technologique en pleine expansion. Cependant, la ville doit faire face à des défis de logement et à la congestion urbaine, limitant son développement optimal.",
    DescripEldoret: "Eldoret, située dans l’ouest du Kenya, est connue pour son rôle dans l’agriculture et le sport, notamment l'athlétisme. La ville est un centre pour la transformation des produits agricoles comme le maïs et le lait. Eldoret possède également un potentiel pour devenir un centre logistique grâce à sa proximité avec l'autoroute reliant le Kenya à l'Ouganda. Pour tirer parti de ces atouts, des efforts sont nécessaires pour développer les infrastructures et renforcer les chaînes de valeur agricoles.",
    ...
    descripMaurice2: "Malgré les défis liés aux fluctuations économiques globales, Maurice continue de faire preuve d’une résilience remarquable. Les Mauriciens s'engagent activement dans la construction d'un avenir durable, avec un accent sur le développement des énergies renouvelables et le renforcement des secteurs de l’éducation et de la santé. Le pays, autrefois dépendant du sucre, a réussi à diversifier son économie vers le tourisme, les services financiers, et les technologies de l'information.",
    advantageMaurice: "L'Île Maurice est un pays aux multiples facettes, avec une diversité géographique et culturelle qui en fait un acteur clé dans l'océan Indien. Elle est composée de plusieurs villes stratégiques, chacune jouant un rôle spécifique dans le développement économique et social du pays.",
    ...
    DescripMahebourg: "Mahébourg, située sur la côte sud-est, est un centre historique et culturel de l'île. Elle est réputée pour son patrimoine colonial et ses marchés traditionnels. Mahébourg a un fort potentiel pour le développement du tourisme, notamment grâce à sa proximité avec l’aéroport et le lagon de Blue Bay.",
    DescripQuatreBornes: "Quatre Bornes, surnommée la \"ville des fleurs\", est un centre commercial et résidentiel dynamique au centre de l'île. La ville est connue pour ses marchés et ses centres commerciaux, ainsi que pour son cadre de vie agréable. Quatre Bornes a un potentiel de développement dans les secteurs de la technologie et des services.",
    ConcMaurice: "Ces quatre villes stratégiques de l'Île Maurice, à travers leurs rôles complémentaires, contribuent de manière significative au développement économique de l'île. Leur diversité économique, leurs positions géographiques avantageuses et les opportunités d'investissement qu'elles offrent en font des moteurs de croissance essentiels.",
      ...
      // Mozambique
      nomMozambique: 'Mozambique',
      descripMozambique1: 'Le Mozambique, souvent appelé "le pays des horizons océaniques", est situé en Afrique australe et est reconnu pour sa diversité culturelle, linguistique et géographique. Cette richesse se manifeste à travers un patrimoine vivant, illustrant la coexistence de plusieurs groupes ethniques, dont les Makua, les Tsonga et les Shona. Le Mozambique est également célèbre pour sa scène artistique dynamique, sa musique entraînante, comme le marrabenta, et ses danses traditionnelles, qui témoignent de l’esprit créatif et de la résilience de son peuple.',
      descripMozambique2: 'Malgré les défis socio-économiques et politiques auxquels il fait face, le Mozambique continue de faire preuve d’une résilience remarquable. Les Mozambicains s\'engagent activement dans la construction d\'un avenir meilleur, avec un accent sur le développement durable et l\'amélioration des conditions de vie. Le pays, riche en ressources naturelles comme le gaz naturel, le charbon et les fruits de mer, aspire à diversifier son économie et à réduire sa dépendance à l\'exportation de matières premières.',
      advantageMozambique: 'Le Mozambique est un pays aux multiples facettes, avec une diversité géographique et culturelle qui en fait un acteur clé en Afrique australe. Il est composé de plusieurs villes stratégiques, chacune jouant un rôle spécifique dans le développement économique et social du pays. Voici un aperçu de quatre villes clés du Mozambique et leurs particularités en matière d\'opportunités économiques et de développement.',
      MaputoDescription: 'Maputo, la capitale et plus grande ville du Mozambique, est le cœur économique et politique du pays. Elle abrite de nombreuses institutions gouvernementales, entreprises, et organisations internationales. Maputo est un centre portuaire et commercial crucial, facilitant les échanges avec l’Afrique du Sud et les pays voisins. Cependant, la ville doit surmonter des défis en matière d’infrastructures et de logement pour accompagner sa croissance rapide.',
      BeiraDescription: 'Beira, le deuxième plus grand port maritime du Mozambique, est un centre logistique essentiel. Située au centre du pays, la ville joue un rôle clé dans le transport et l\'exportation de minerais et de produits agricoles vers le reste du monde. Le développement de Beira nécessite toutefois des améliorations des infrastructures portuaires pour répondre à la demande croissante et renforcer sa résilience face aux cyclones.',
      ...
      PembaDescription: 'Pemba, située au nord du Mozambique, est connue pour ses ressources en gaz naturel, notamment dans le bassin du Rovuma. La ville est un centre émergent pour les industries du gaz et du pétrole. En plus de son potentiel énergétique, Pemba possède des paysages naturels propices au tourisme. Pour soutenir son développement, des efforts sont nécessaires pour améliorer les infrastructures locales et renforcer la sécurité dans la région.',
      conclusionMozambique: 'Ces quatre villes stratégiques du Mozambique, à travers leurs rôles complémentaires, contribuent de manière significative au développement économique du pays. Leur diversité économique, leurs positions géographiques avantageuses et les opportunités d\'investissement qu\'elles offrent en font des moteurs de croissance essentiels. Pour réaliser leur plein potentiel, le Mozambique doit continuer à investir dans les infrastructures et à améliorer la gouvernance locale, favorisant ainsi un développement harmonieux et durable.',

      // Rwanda
      nomRwanda: 'Rwanda',
      descripRwanda1: 'Le Rwanda, souvent surnommé le pays des mille collines, est un pays situé en Afrique de l\'Est, reconnu pour sa richesse culturelle, linguistique et naturelle. Cette diversité enrichit son patrimoine et reflète l\'harmonie entre les différentes ethnies qui composent la nation. Le Rwanda est également célèbre pour sa scène artistique dynamique, sa musique captivante et ses danses traditionnelles, qui illustrent l\'esprit créatif et résilient de son peuple.',
      descripRwanda2: 'Après les tragiques événements de 1994, le Rwanda a démontré une résilience remarquable. Les Rwandais sont engagés dans la construction d\'un avenir meilleur, avec un accent fort sur le développement durable et l\'amélioration de la qualité de vie. Le pays est devenu un modèle de croissance économique en Afrique, intégrant des politiques innovantes et un environnement favorable aux affaires.',
      advantageRwanda: 'Le Rwanda est un pays doté d\'une diversité géographique et économique qui en fait un acteur stratégique de la région des Grands Lacs. Il est composé de plusieurs villes - clés, chacune jouant un rôle particulier dans le développement économique et social du pays.Voici un aperçu de quatre villes stratégiques du Rwanda et leurs spécificités en matière d\'opportunités économiques et de développement.',
      KigaliDescription: 'Kigali, la capitale et plus grande ville du Rwanda, est le centre névralgique de l\'économie nationale. Elle abrite de nombreuses institutions gouvernementales, entreprises et organisations internationales. La ville est un hub pour les services, le commerce et le tourisme, attirant des investissements étrangers. Cependant, Kigali doit faire face à des défis d\'infrastructure et de gestion urbaine pour soutenir sa croissance rapide.',
      ButareDescription: 'Butare, anciennement connue comme la ville universitaire du Rwanda, est réputée pour sa riche histoire et son patrimoine culturel. Elle abrite l\'Université nationale du Rwanda et plusieurs institutions éducatives. Le potentiel de Butare réside dans le développement du tourisme culturel et éducatif, mais des investissements dans les infrastructures et les services de base sont nécessaires pour améliorer la qualité de vie.',
      GisenyiDescription: 'Gisenyi, située au bord du lac Kivu, est une destination touristique prisée en raison de ses paysages pittoresques et de ses activités récréatives. La ville a un potentiel économique significatif dans le secteur du tourisme et de l\'agriculture. Toutefois, pour maximiser ses atouts, Gisenyi doit améliorer ses infrastructures et diversifier son offre touristique.',
      HuyeDescription: 'Huye, ancienne capitale du Rwanda, est un centre agro-industriel important, notamment dans la production de café et de thé. La ville joue un rôle clé dans le commerce des produits agricoles, mais elle doit renforcer ses infrastructures pour soutenir le développement de ses ',
      conclusionRwanda: 'Ces quatre villes stratégiques de la Côte d\'Ivoire, chacune avec ses atouts uniques, contribuent de manière significative au développement économique du pays.Leur diversité économique, leurs positions géographiques avantageuses et les opportunités d\'investissement qu\'elles offrent en font des moteurs de croissance essentiels.Pour réaliser leur plein potentiel, il est impératif que la Côte d\'Ivoire investisse davantage dans les infrastructures et améliore la gouvernance locale, favorisant ainsi un développement harmonieux et durable.',
      ...
      descripMauritanie1: 'La Mauritanie, souvent surnommée "le pays des sables et de l\'océan", est située en Afrique de l\'Ouest et est reconnue pour sa diversité culturelle, linguistique et géographique. Cette richesse se reflète dans son patrimoine vivant, marqué par la coexistence de plusieurs groupes ethniques, dont les Maures, les Soninkés, et les Wolofs. La Mauritanie est aussi célèbre pour son patrimoine musical unique, ses poèmes lyriques et ses danses traditionnelles, qui incarnent l\'esprit créatif et la résilience de son peuple.',
      descripMauritanie2: 'Malgré les défis socio-économiques et politiques, la Mauritanie continue de faire preuve d\'une grande résilience. Les Mauritaniens œuvrent activement à la construction d\'un avenir meilleur, avec un accent sur le développement durable et l\'amélioration des conditions de vie. Le pays, riche en ressources naturelles comme le fer, l’or et les ressources halieutiques, cherche à diversifier son économie et à réduire sa dépendance aux matières premières.',
      ...
      conclusionSoudan: 'Ces quatre villes stratégiques du Soudan, à travers leurs rôles complémentaires, contribuent de manière significative au développement économique du pays. Leur diversité économique, leurs positions géographiques avantageuses et les opportunités d\'investissement qu\'elles offrent en font des moteurs de croissance essentiels. Pour réaliser leur plein potentiel, le Soudan doit continuer à investir dans les infrastructures et à améliorer la gouvernance locale, favorisant ainsi un développement harmonieux et durable.',
       ...
       // Botswana
       nomBotswana: 'Botswana',
       descripBotswana1: "Le Botswana, situé en Afrique australe, est un pays reconnu pour sa stabilité politique, sa bonne gouvernance et ses vastes ressources naturelles. Surnommé 'le pays des diamants', le Botswana est également célèbre pour sa biodiversité impressionnante, notamment dans le parc national de Chobe et le delta de l'Okavango, classé au patrimoine mondial de l'UNESCO. Cette richesse naturelle fait du Botswana une destination prisée pour le tourisme, tout en offrant des opportunités de développement durable.",
       descripBotswana2: "Malgré des défis liés à la pauvreté et à la dépendance vis-à-vis des ressources minérales, le Botswana continue de démontrer une résilience remarquable en investissant dans l'éducation, la santé et l'infrastructure pour favoriser une croissance inclusive.",
       advantageBotswana: 'Le Botswana possède une économie diversifiée qui tire parti de ses richesses naturelles et de son capital humain. Voici un aperçu de trois villes clés du pays et de leurs spécificités en matière d\'opportunités économiques et de développement.',
       ...
       FrancistownDescription: "Francistown, la deuxième plus grande ville du pays, est un important centre commercial et industriel. Située à proximité de la frontière avec le Zimbabwe, Francistown est stratégiquement positionnée pour faciliter le commerce transfrontalier. La ville est un centre d'industries telles que la transformation alimentaire et l'extraction minière. En investissant dans des infrastructures de transport et des services publics, Francistown pourrait devenir un pôle d'attraction pour les investissements régionaux et internationaux.",
      ...
      advantageSuaziland: 'L’Eswatini est un pays aux multiples facettes, avec une diversité géographique et culturelle qui en fait un acteur unique en Afrique australe. Il est composé de plusieurs villes stratégiques, chacune jouant un rôle spécifique dans le développement économique et social du pays. Voici un aperçu de quatre villes clés de l’Eswatini et leurs particularités en matière d\'opportunités économiques et de développement.',
      MbabaneDescription: "Mbabane, la capitale administrative de l’Eswatini, est le centre politique et économique du pays. Elle abrite de nombreuses institutions gouvernementales et organisations internationales. Située au cœur des montagnes, Mbabane joue un rôle important dans le secteur des services, mais elle doit surmonter des défis liés à l’urbanisation et aux infrastructures pour mieux soutenir son développement.",
      ManziniDescription: "Manzini, la ville la plus peuplée de l’Eswatini, est un centre commercial et industriel crucial. La ville est le principal nœud de transport et d'échange du pays, facilitant les échanges avec l’Afrique du Sud voisine. Manzini attire des investissements dans l’industrie manufacturière et les services, mais des améliorations dans les infrastructures de transport sont nécessaires pour soutenir sa croissance.",
      SitekiDescription: "Siteki, située dans l'est de l’Eswatini, est un centre important pour l’agriculture et l’élevage. La ville est entourée de terres fertiles, idéales pour la production de sucre et de cultures vivrières. Siteki a un potentiel significatif pour le développement agro-industriel, mais des investissements dans les infrastructures de transport et la formation des agriculteurs sont essentiels pour maximiser son rendement.",
      LobambaDescription: "Lobamba, la capitale culturelle et spirituelle de l’Eswatini, est le siège du Parlement et de la famille royale. C'est un centre culturel important, attirant des visiteurs pour ses sites historiques et ses événements traditionnels, comme le Umhlanga (la danse des roseaux). Lobamba possède un fort potentiel dans le secteur du tourisme culturel, mais nécessite davantage de promotion et d'investissements dans les infrastructures touristiques pour en tirer pleinement parti.",
      conclusionSuaziland: "Ces quatre villes stratégiques de l'Eswatini, à travers leurs rôles complémentaires, contribuent de manière significative au développement économique du pays. Leur diversité économique, leurs positions géographiques stratégiques et les opportunités d'investissement qu'elles offrent en font des moteurs de croissance essentiels. Pour réaliser leur plein potentiel, l'Eswatini doit continuer à investir dans les infrastructures et à promouvoir son patrimoine culturel, favorisant ainsi un développement harmonieux et durable.",

      // South Africa (Afrique du Sud)
      nomAfriqueDuSud: 'Afrique du Sud',
      descripAfriqueDuSud1: "L’Afrique du Sud, souvent appelée la 'Nation arc-en-ciel', est reconnue pour sa diversité culturelle, linguistique et géographique. Cette richesse se reflète dans un patrimoine vivant, illustrant la coexistence de plusieurs groupes ethniques. Le pays est célèbre pour sa scène artistique dynamique, sa musique et ses danses traditionnelles, qui témoignent de la créativité et de la résilience de son peuple.",
      descripAfriqueDuSud2: "Malgré des défis socio-économiques, l'Afrique du Sud continue de montrer une résilience et un engagement envers le développement durable en investissant dans les infrastructures, l'éducation et les conditions de vie.",
      advantageAfriqueDuSud: "Les villes sud-africaines jouent un rôle vital dans la croissance économique et le développement du pays, chacune offrant des opportunités uniques basées sur leur géographie, leurs ressources et leurs industries locales. Voici un aperçu des villes clés et de leur potentiel économique:",
      JohannesburgDescription: "Johannesburg, la plus grande ville et moteur économique du pays, est un centre financier et commercial majeur. Connue sous le nom de 'Cité de l'or', elle possède une économie florissante alimentée par des industries comme l'extraction minière, la finance et la technologie.",
      DurbanDescription: "Durban, située sur l'océan Indien, est l'un des ports les plus fréquentés d'Afrique et un centre industriel important, notamment dans les secteurs pétrochimique, du sucre et du transport maritime.",
      CapeTownDescription: "Le Cap, célèbre pour sa beauté naturelle et son patrimoine, est un centre clé pour le tourisme, l'agriculture et les industries créatives. Son port joue également un rôle important dans le commerce international.",
      PretoriaDescription: "Pretoria, la capitale administrative, abrite des institutions gouvernementales et est fortement présente dans les secteurs de l'éducation, de la défense et de la technologie.",
      conclusionAfriqueDuSud: "Les villes sud-africaines, avec leurs diverses forces économiques et leurs avantages géographiques, contribuent au développement du pays. Investir dans les infrastructures, l'éducation et l'innovation est essentiel pour exploiter pleinement le potentiel de chaque ville en vue d'une croissance durable.",


      // Comores
      nomComore: 'Comore',
      descripComore1: "Les Comores, souvent appelées les îles parfumées, sont un archipel situé dans l'océan Indien, entre Madagascar et la côte continentale de l'Afrique. Reconnu pour sa biodiversité, sa culture unique et ses paysages époustouflants, cet archipel se distingue par ses traditions séculaires et son patrimoine naturel exceptionnel.",
      descripComore2: "Malgré des défis socio-économiques et politiques, les Comores font preuve d'une résilience notable. Le peuple comorien est engagé dans la préservation de son patrimoine tout en aspirant à un développement durable qui valorise à la fois la nature et la culture.",
      advantageComore: "Les Comores, avec leur position géographique stratégique, présentent des opportunités intéressantes dans divers secteurs économiques. Voici un aperçu de trois îles clés de l'archipel et de leurs spécificités en matière d'opportunités économiques et de développement.",
      GrandeComoreDescription: "Grande Comore, la plus grande des îles, est le cœur économique et administratif de l'archipel. La ville de Moroni, capitale nationale, abrite l'aéroport international de Hahaya, facilitant les échanges avec le monde extérieur. L'île est riche en ressources naturelles, notamment la vanille, le ylang-ylang et d'autres épices, qui représentent des opportunités importantes pour l'agriculture et l'exportation. Toutefois, des efforts sont nécessaires pour améliorer les infrastructures, en particulier dans les domaines des transports et de la santé.",
      MoheliDescription: "Mohéli, l'une des plus petites îles de l'archipel, se distingue par sa biodiversité marine et ses paysages préservés. Le parc marin de Mohéli, qui attire les amateurs de plongée et de nature, représente un potentiel significatif pour le tourisme durable. Le développement d'infrastructures touristiques respectueuses de l'environnement pourrait stimuler l'économie locale et préserver les ressources naturelles de l'île.",
      AnjouanDescription: "Anjouan, connue pour ses collines verdoyantes et ses plantations, est le centre agricole des Comores. L'île produit des cultures comme le café, le cacao et les agrumes, qui sont essentiels pour l'économie locale. Avec des efforts pour moderniser les techniques agricoles et améliorer l'accès aux marchés, Anjouan pourrait renforcer sa contribution à l'économie nationale tout en soutenant la sécurité alimentaire.",
      conclusionComore: "Les Comores, avec leurs îles uniques et leurs atouts diversifiés, jouent un rôle important dans la dynamique économique de l'océan Indien. Leur richesse culturelle, leurs ressources naturelles et leur potentiel touristique offrent des perspectives de croissance. Pour maximiser ces opportunités, il est crucial que les Comores investissent dans les infrastructures, renforcent les capacités locales et promeuvent une gouvernance efficace. Cela permettra de favoriser un développement durable, tout en préservant l'identité culturelle et les richesses naturelles de l'archipel.",

      // Madagascar
      nomMadagascar: 'Madagascar',
      descripMadagascar1: "Madagascar, la quatrième plus grande île du monde, est célèbre pour sa biodiversité exceptionnelle, dont une grande partie est endémique. Surnommée « l’île-continent », elle se distingue par une variété d’écosystèmes allant des forêts tropicales luxuriantes aux déserts épineux. Outre son environnement unique, Madagascar possède également d'énormes ressources naturelles et un potentiel économique dans des secteurs tels que l’agriculture, le tourisme, et l’exploitation minière.",
      descripMadagascar2: "L’île fait face à des défis économiques et sociaux, mais les réformes engagées et les initiatives visant à développer des infrastructures durables contribuent à son dynamisme croissant. En mettant l’accent sur l’agriculture, la pêche, et l’écotourisme, Madagascar cherche à promouvoir une croissance économique équilibrée et respectueuse de l’environnement.",
      ...
      conclusionMadagascar: "Antananarivo, Toamasina, Mahajanga et Antsiranana sont des moteurs économiques clés pour Madagascar, chacune offrant des atouts spécifiques qui contribuent à la croissance du pays. Les secteurs tels que l'agriculture, l'exploitation minière, la pêche et le tourisme, soutiennent l'économie malgache, tandis que des efforts sont en cours pour diversifier les sources de revenus et renforcer les infrastructures. La préservation de l’environnement et la promotion du tourisme durable restent des priorités pour maximiser le potentiel de l’île sans compromettre ses écosystèmes uniques.",

     
        // British Columbia (Colombie-Britannique)
        nomColombieBritannique: 'Colombie-Britannique',
        descripColombieBritannique1: "La Colombie-Britannique, située à l'extrémité ouest du Canada, est une province célèbre pour ses paysages spectaculaires, allant des montagnes majestueuses aux vastes forêts pluviales côtières. Sa diversité naturelle se reflète également dans sa population, riche d'influences autochtones et multiculturelles.",
        descripColombieBritannique2: "Malgré les défis liés à l'urbanisation et à la protection de son environnement unique, la province continue de prospérer grâce à une économie diversifiée et en croissance rapide. La Colombie-Britannique se concentre de plus en plus sur le développement durable, avec des initiatives visant à réduire son empreinte carbone tout en favorisant l'innovation technologique.",
        advantageColombieBritannique: "La Colombie-Britannique, en tant que province côtière, bénéficie d'une position stratégique pour le commerce et les investissements. Voici un aperçu de quatre villes stratégiques de la Colombie-Britannique et de leurs spécificités en termes d'opportunités économiques et de développement.",
        VancouverDescription: "Vancouver, la plus grande ville de la Colombie-Britannique, est le cœur économique de la province. La ville abrite l'un des ports les plus importants d'Amérique du Nord, le Port de Vancouver, qui relie le Canada aux marchés mondiaux, notamment ceux de l'Asie-Pacifique. Elle est également un pôle technologique en pleine expansion, attirant des entreprises dans les domaines des technologies de l'information, des médias numériques et des industries vertes.",
        VictoriaDescription: "Victoria, la capitale de la Colombie-Britannique, située sur l'île de Vancouver, est connue pour sa beauté naturelle et son riche patrimoine historique. La ville joue un rôle clé dans le secteur du tourisme, avec des millions de visiteurs chaque année. Victoria abrite également des institutions gouvernementales, offrant ainsi des opportunités dans l'administration publique et l'éducation.",
        KelownaDescription: "Kelowna, située dans la vallée de l’Okanagan, est une ville en pleine croissance qui se distingue par son industrie vinicole et son tourisme. Les vignobles et les vergers de la région attirent des touristes et investisseurs, faisant de l’agriculture et du tourisme deux piliers économiques de la ville.",
        PrinceGeorgeDescription: "Prince George est une ville clé dans le nord de la Colombie-Britannique, souvent décrite comme la porte d'entrée vers les ressources naturelles de la province. Son économie repose principalement sur les industries forestières, minières et énergétiques, faisant d'elle un centre névralgique pour l'exploitation des ressources.",
        conclusionColombieBritannique: "Les quatre villes stratégiques de la Colombie-Britannique sont des moteurs essentiels pour le développement de la province. Vancouver, Victoria, Kelowna et Prince George offrent des opportunités uniques dans des secteurs allant de la technologie et du tourisme à l’exploitation des ressources naturelles.",
  
        // Alberta
        nomAlberta: 'Alberta',
        descripAlberta1: "L'Alberta, une province de l'ouest du Canada, est reconnue pour ses vastes plaines, ses montagnes imposantes et ses riches ressources naturelles, notamment le pétrole et le gaz. Bien que son économie soit historiquement ancrée dans l'exploitation des ressources, l'Alberta s’efforce de diversifier ses secteurs pour devenir une plaque tournante dans les domaines de l'agriculture, de la technologie, et des énergies renouvelables.",
        descripAlberta2: "Cette province offre un environnement propice aux affaires, avec une qualité de vie élevée et un esprit d’innovation. Les défis liés à la durabilité environnementale et à la transition énergétique sont au cœur des préoccupations, alors que l'Alberta s'engage à bâtir un avenir plus vert.",
        advantageAlberta: "L'Alberta joue un rôle clé dans l'économie canadienne grâce à ses ressources naturelles et à sa position géographique. Voici un aperçu de quatre villes stratégiques de l'Alberta et leurs atouts en matière de développement et d'opportunités économiques.",
        CalgaryDescription: "Calgary est la plus grande ville de l'Alberta et le centre économique de la province. Réputée pour être un hub mondial de l'industrie énergétique, elle abrite de nombreuses entreprises dans les secteurs du pétrole, du gaz et des services financiers.",
        EdmontonDescription: "Edmonton, la capitale de l'Alberta, est connue pour ses festivals culturels et son rôle en tant que centre gouvernemental et éducatif. L'économie d'Edmonton repose principalement sur le secteur public, la recherche universitaire, ainsi que sur le commerce de détail et la santé.",
        RedDeerDescription: "Red Deer, située entre Calgary et Edmonton, est une ville en pleine expansion avec une économie basée sur l'agriculture, l'industrie et les services. Elle bénéficie d'une situation géographique idéale pour le transport et la logistique.",
        FortMcMurrayDescription: "Fort McMurray, au nord de l'Alberta, est surtout connue pour être le cœur des sables bitumineux du Canada. Ce centre industriel est essentiel pour l'extraction du pétrole, ce qui en fait un acteur majeur de l'économie de la province.",
        conclusionAlberta: "Calgary, Edmonton, Red Deer et Fort McMurray jouent un rôle clé dans le développement de l’Alberta. Leur importance pour les industries de l'énergie, des ressources naturelles, ainsi que pour les secteurs émergents comme la technologie est essentielle à l'économie provinciale.",
  
        // Prince Edward Island (Île-du-Prince-Édouard)
        nomIleDuPrinceEdouard: 'Île-du-Prince-Édouard',
        descripIleDuPrinceEdouard1: "L'Île-du-Prince-Édouard (Î.-P.-É.), la plus petite province du Canada, est connue pour ses paysages côtiers pittoresques, ses terres agricoles fertiles et son riche patrimoine culturel. Avec une économie qui repose historiquement sur l'agriculture, la pêche et le tourisme, l'Î.-P.-É. continue de diversifier ses secteurs économiques.",
        descripIleDuPrinceEdouard2: "Bien que confrontée à des défis liés à son éloignement géographique et à la protection de ses côtes vulnérables face au changement climatique, l'île maintient une croissance stable et s’impose dans la production agricole, en particulier des pommes de terre.",
        advantageIleDuPrinceEdouard: "L'Île-du-Prince-Édouard, bien que petite, offre des opportunités économiques variées et stratégiques. Voici un aperçu de quatre villes stratégiques et de leurs spécificités en termes de développement économique.",
        CharlottetownDescription: "Charlottetown, la capitale de l'Î.-P.-É., est surnommée le 'berceau de la Confédération' pour son rôle dans la naissance du Canada. La ville est également un centre culturel avec festivals, musées et théâtres.",
        SummersideDescription: "Summerside, la deuxième plus grande ville, est un hub pour les secteurs de l'aérospatiale, de la technologie de l'information et des services financiers. Summerside soutient aussi l'énergie renouvelable, surtout éolienne.",
        SourisDescription: "Souris est une petite ville portuaire jouant un rôle important dans le transport maritime et la pêche. Elle est un point d'entrée pour les ferries reliant l'Î.-P.-É. aux Îles-de-la-Madeleine.",
        MontagueDescription: "Montague est un centre régional pour les communautés rurales environnantes. L'économie repose sur l'agriculture, en particulier la production de pommes de terre et de fruits de mer.",
        conclusionIleDuPrinceEdouard: "Charlottetown, Summerside, Souris et Montague contribuent à la prospérité de la province. Leur diversité économique, avec une beauté naturelle exceptionnelle, fait de l'Î.-P.-É. un lieu où tradition et innovation coexistent.",
  
        // Manitoba
        nomManitoba: 'Manitoba',
        descripManitoba1: "Le Manitoba, situé au cœur du Canada, est une province vaste et diversifiée avec une économie fortement ancrée dans l'agriculture, les ressources naturelles et l'industrie. Ses paysages variés, des plaines fertiles aux forêts boréales, offrent un cadre propice au tourisme.",
        descripManitoba2: "Bien que l'économie repose historiquement sur l'agriculture, la province se diversifie avec des investissements dans les secteurs de la fabrication, des technologies de l'information, et des énergies renouvelables.",
        advantageManitoba: "Le Manitoba offre de nombreuses opportunités économiques. Voici un aperçu de quatre villes stratégiques du Manitoba et de leurs spécificités en termes de développement.",
        WinnipegDescription: "Winnipeg, la capitale, est le cœur économique de la province. Historiquement un centre de transport, Winnipeg a une économie diversifiée et est un pôle important pour la fabrication et les technologies de l'information.",
        BrandonDescription: "Brandon est connue comme le grenier du Manitoba grâce à son secteur agricole. La ville est un centre de transformation des aliments et de la production agricole.",
        ThompsonDescription: "Thompson est qualifiée de Capitale du Nord du Manitoba en raison de son importance dans l'industrie minière, principalement pour le nickel.",
        PortageLaPrairieDescription: "Portage la Prairie est un centre pour l'agriculture et la transformation alimentaire. La ville attire des investissements industriels, notamment dans l'agroalimentaire.",
        conclusionManitoba: "Winnipeg, Brandon, Thompson et Portage la Prairie sont des moteurs de croissance essentiels pour le Manitoba. La province, avec un équilibre entre secteurs forts et nouveaux secteurs émergents, est bien positionnée pour une croissance durable.",

        nomColombieBritannique: 'Colombie-Britannique',
      descripColombieBritannique1: "La Colombie-Britannique, située à l'extrémité ouest du Canada, est une province reconnue pour ses paysages spectaculaires, allant de majestueuses montagnes à de vastes forêts pluviales côtières. Sa diversité naturelle se reflète également dans sa population, riche en influences autochtones et multiculturelles. La Colombie-Britannique sert de pont entre l'Amérique du Nord et la région Asie-Pacifique, ce qui en fait un acteur clé du commerce international.",
      descripColombieBritannique2: "Malgré les défis liés à l'urbanisation et à la protection de son environnement unique, la province continue de prospérer avec une économie diversifiée et en pleine croissance. La Colombie-Britannique se concentre de plus en plus sur le développement durable, avec des initiatives visant à réduire son empreinte carbone tout en favorisant l'innovation technologique.",
      advantageColombieBritannique: "En tant que province côtière, la Colombie-Britannique bénéficie d'une position stratégique pour le commerce et les investissements. Voici un aperçu de quatre villes stratégiques en Colombie-Britannique et de leurs opportunités uniques de développement économique.",
      VancouverDescription: "Vancouver, la plus grande ville de Colombie-Britannique, est le cœur économique de la province. La ville abrite l'un des plus grands ports d'Amérique du Nord, le port de Vancouver, reliant le Canada aux marchés mondiaux, notamment ceux de la région Asie-Pacifique. Elle est également un pôle technologique en pleine expansion, attirant des entreprises dans les technologies de l'information, les médias numériques et les industries vertes.",
      VictoriaDescription: "Victoria, la capitale de la Colombie-Britannique, située sur l'île de Vancouver, est réputée pour sa beauté naturelle et son riche patrimoine historique. La ville joue un rôle clé dans le secteur touristique, accueillant des millions de visiteurs chaque année. Victoria abrite également des institutions gouvernementales, offrant des opportunités dans l'administration publique et l'éducation.",
      KelownaDescription: "Kelowna, située dans la vallée de l'Okanagan, est une ville en pleine croissance connue pour son industrie vinicole et son tourisme. Les vignobles et vergers de la région attirent touristes et investisseurs, faisant de l'agriculture et du tourisme deux piliers économiques de la ville.",
      PrinceGeorgeDescription: "Prince George est une ville clé dans le nord de la Colombie-Britannique, souvent décrite comme la porte d'entrée vers les ressources naturelles de la province. Son économie est principalement basée sur les industries forestières, minières et énergétiques, en faisant un centre névralgique pour l'extraction des ressources.",
      conclusionColombieBritannique: "Les quatre villes stratégiques de la Colombie-Britannique sont des moteurs essentiels du développement de la province. Vancouver, Victoria, Kelowna et Prince George offrent des opportunités uniques dans des secteurs allant de la technologie et du tourisme à l'extraction des ressources naturelles.",

      // Alberta
      nomAlberta: 'Alberta',
      descripAlberta1: "L'Alberta, une province de l'ouest du Canada, est reconnue pour ses vastes plaines, ses montagnes imposantes et ses riches ressources naturelles, notamment le pétrole et le gaz. Bien que son économie ait historiquement reposé sur l'extraction de ressources, l'Alberta s'efforce de diversifier ses industries pour devenir un pôle en agriculture, technologie et énergies renouvelables.",
      descripAlberta2: "Cette province offre un environnement propice aux affaires avec une haute qualité de vie et un esprit d'innovation. Les défis liés à la durabilité environnementale et à la transition énergétique sont au cœur des efforts de l'Alberta pour construire un avenir plus vert tout en maintenant sa position de leader économique au Canada.",
      advantageAlberta: "L'Alberta joue un rôle clé dans l'économie canadienne grâce à ses ressources naturelles et à sa position géographique. Voici un aperçu de quatre villes stratégiques en Alberta et de leurs points forts en matière d'économie et de développement.",
      CalgaryDescription: "Calgary est la plus grande ville de l'Alberta et le centre économique de la province. Connue comme un pôle mondial de l'industrie énergétique, elle abrite de nombreuses entreprises de pétrole, de gaz et de services financiers.",
      EdmontonDescription: "Edmonton, la capitale de l'Alberta, est réputée pour ses festivals culturels et son rôle de centre administratif et éducatif.",
      RedDeerDescription: "Red Deer, située entre Calgary et Edmonton, est une ville en pleine croissance avec une économie basée sur l'agriculture, l'industrie et les services.",
      FortMcMurrayDescription: "Fort McMurray, dans le nord de l'Alberta, est connu pour être le cœur des sables bitumineux du Canada.",
      conclusionAlberta: "Calgary, Edmonton, Red Deer et Fort McMurray jouent chacun un rôle crucial dans le développement de l'Alberta.",

      // Nouvelle-Écosse
      nomNouvelleEcosse: 'Nouvelle-Écosse',
      descripNouvelleEcosse1: "La Nouvelle-Écosse, l'une des provinces maritimes du Canada, est connue pour ses paysages côtiers époustouflants, sa riche histoire et ses communautés dynamiques. Cette province, à la fois rurale et urbaine, est un centre historique important pour l'économie canadienne, avec des industries clés telles que la pêche, la construction navale et, plus récemment, les technologies de l'information et le secteur des services.",
      descripNouvelleEcosse2: "En tant que porte d'entrée de l'Atlantique, la Nouvelle-Écosse bénéficie d'une position stratégique pour le commerce international.",
      advantageNouvelleEcosse: "La Nouvelle-Écosse, avec son emplacement géographique unique et ses ressources maritimes, offre des opportunités économiques diversifiées.",
      HalifaxDescription: "Halifax, la capitale et plus grande ville de la Nouvelle-Écosse, est le centre économique, culturel et éducatif de la province.",
      SydneyDescription: "Sydney, située sur l'île du Cap-Breton, est un centre important pour les industries du charbon et de l'acier.",
      TruroDescription: "Truro, souvent appelée le Hub de la Nouvelle-Écosse, est stratégiquement située à l'intersection des principales routes et voies ferrées de la province.",
      LunenburgDescription: "Lunenburg, site du patrimoine mondial de l'UNESCO, est l'une des villes historiques les plus célèbres du Canada.",
      conclusionNouvelleEcosse: "Halifax, Sydney, Truro et Lunenburg sont des centres stratégiques contribuant à la prospérité de la Nouvelle-Écosse.",

      // i18n.js

  // Colombie-Britannique
  nomColombieBritannique: 'Colombie-Britannique',
  descripColombieBritannique1: "La Colombie-Britannique, située à l'extrémité ouest du Canada, est une province reconnue pour ses paysages spectaculaires, allant des montagnes majestueuses aux vastes forêts pluviales côtières et aux superbes plages. Sa diversité naturelle se reflète également dans sa population, riche en influences autochtones et multiculturelles, ce qui en fait une région marquée par la diversité culturelle. La Colombie-Britannique sert de pont entre l'Amérique du Nord et la région Asie-Pacifique, ce qui en fait un acteur clé du commerce international, particulièrement grâce à ses infrastructures de transport modernes et son ouverture au commerce extérieur.",
  descripColombieBritannique2: "Bien que la province soit confrontée à des défis liés à l'urbanisation rapide et à la protection de son environnement unique, elle continue de prospérer avec une économie diversifiée et en pleine croissance, axée sur le tourisme, la technologie et les industries vertes. La Colombie-Britannique se concentre de plus en plus sur le développement durable, avec des initiatives visant à réduire son empreinte carbone tout en favorisant l'innovation technologique, notamment dans les énergies renouvelables et la gestion écologique des ressources naturelles.",
  advantageColombieBritannique: "En tant que province côtière, la Colombie-Britannique bénéficie d'une position stratégique pour le commerce et les investissements, attirant des entreprises et des talents du monde entier. Voici un aperçu de quatre villes stratégiques en Colombie-Britannique et de leurs opportunités uniques de développement économique.",
  VancouverDescription: "Vancouver, la plus grande ville de Colombie-Britannique, est le cœur économique de la province et l'une des villes les plus dynamiques du Canada. La ville abrite l'un des plus grands ports d'Amérique du Nord, le port de Vancouver, qui relie le Canada aux marchés mondiaux, en particulier ceux de la région Asie-Pacifique. Vancouver est également un pôle technologique en pleine expansion, attirant des entreprises dans les secteurs de la technologie de l'information, des médias numériques et des industries vertes. La ville est un centre cosmopolite et multiculturel, avec une forte population internationale qui contribue à son dynamisme culturel et économique.",
  VictoriaDescription: "Victoria, la capitale de la Colombie-Britannique, située sur l'île de Vancouver, est réputée pour sa beauté naturelle exceptionnelle et son riche patrimoine historique. La ville joue un rôle clé dans le secteur touristique, accueillant chaque année des millions de visiteurs attirés par ses jardins, musées et édifices historiques. Victoria est également le siège du gouvernement provincial, ce qui en fait un centre important pour les institutions publiques, l'administration et l'éducation. La ville est de plus en plus reconnue pour ses initiatives en matière de développement durable et d'innovations écologiques.",
  KelownaDescription: "Kelowna, située dans la pittoresque vallée de l'Okanagan, est une ville en pleine croissance connue pour son industrie vinicole et son attractivité touristique. La région est célèbre pour ses vignobles et vergers, attirant des touristes et des investisseurs du monde entier. L'agriculture et le tourisme constituent les piliers économiques de Kelowna, mais la ville se diversifie également dans les technologies propres et les énergies renouvelables.",
  PrinceGeorgeDescription: "Prince George est une ville clé dans le nord de la Colombie-Britannique, souvent décrite comme la porte d'entrée vers les ressources naturelles de la province. Avec une économie principalement basée sur les industries forestières, minières et énergétiques, Prince George est un centre névralgique pour l'extraction et la gestion des ressources. La ville cherche à diversifier son économie en attirant des investissements dans les secteurs des énergies renouvelables et des technologies avancées.",
  conclusionColombieBritannique: "Les quatre villes stratégiques de la Colombie-Britannique - Vancouver, Victoria, Kelowna et Prince George - sont des moteurs essentiels pour le développement de la province. Chacune de ces villes contribue à sa manière à l'économie diversifiée de la Colombie-Britannique, offrant des opportunités dans des secteurs variés allant de la technologie et du tourisme à l'exploitation des ressources naturelles et au commerce international.",

  // Alberta
  nomAlberta: 'Alberta',
  descripAlberta1: "L'Alberta, une province emblématique de l'ouest du Canada, est renommée pour ses vastes plaines, ses montagnes majestueuses et ses riches ressources naturelles, notamment le pétrole, le gaz et les minéraux. Longtemps dépendante de l'extraction de ressources, l'Alberta cherche aujourd'hui à diversifier ses industries pour inclure l'agriculture, la technologie, et les énergies renouvelables, en vue de bâtir une économie plus résiliente et durable.",
  descripAlberta2: "Cette province offre un environnement favorable aux affaires avec une qualité de vie élevée et un esprit d'innovation. Les défis liés à la durabilité environnementale et à la transition énergétique sont au cœur des efforts de l'Alberta pour construire un avenir plus vert tout en conservant son rôle de leader économique au Canada. La province investit dans des infrastructures vertes et dans la recherche de solutions technologiques pour les industries traditionnelles, assurant ainsi une adaptation aux exigences environnementales contemporaines.",
  advantageAlberta: "L'Alberta joue un rôle clé dans l'économie canadienne grâce à ses ressources naturelles abondantes et à sa situation géographique centrale pour le commerce intérieur. Voici un aperçu de quatre villes stratégiques en Alberta et de leurs forces économiques et de développement.",
  CalgaryDescription: "Calgary, la plus grande ville de l'Alberta, est également son centre économique. Réputée pour être un pôle mondial dans l'industrie de l'énergie, Calgary accueille de nombreuses entreprises de pétrole et de gaz ainsi que des services financiers qui contribuent à sa prospérité. La ville s'oriente de plus en plus vers l'innovation et les technologies propres, cherchant à combiner croissance économique et durabilité environnementale.",
  EdmontonDescription: "Edmonton, la capitale de l'Alberta, est connue pour sa riche vie culturelle, avec de nombreux festivals qui attirent des visiteurs du monde entier. En tant que centre administratif, elle abrite les principales institutions gouvernementales de la province et est un important centre d'éducation et de recherche, avec plusieurs universités et centres de recherche de pointe.",
  RedDeerDescription: "Red Deer, située entre Calgary et Edmonton, est une ville en pleine croissance dont l'économie repose sur l'agriculture, l'industrie et les services. La ville bénéficie d'un emplacement stratégique et cherche à développer davantage ses secteurs industriels et technologiques pour répondre aux besoins économiques régionaux.",
  FortMcMurrayDescription: "Fort McMurray, dans le nord de l'Alberta, est mondialement connue pour être le cœur des sables bitumineux du Canada. La ville joue un rôle crucial dans l'exploitation des ressources pétrolières et continue d'être un moteur de l'économie canadienne malgré les défis environnementaux associés à l'extraction de ces ressources.",
  conclusionAlberta: "Calgary, Edmonton, Red Deer et Fort McMurray sont des moteurs économiques essentiels de l'Alberta, chacun apportant une contribution unique. La province continue d'explorer de nouvelles avenues pour une croissance durable, s'appuyant sur l'innovation, la diversité industrielle et l'engagement en faveur de l'environnement.",

  // Nouvelle-Écosse
  nomNouvelleEcosse: 'Nouvelle-Écosse',
  descripNouvelleEcosse1: "La Nouvelle-Écosse, l'une des provinces maritimes du Canada, est connue pour ses paysages côtiers époustouflants, ses communautés dynamiques et sa richesse historique. Mélange d'urbanisme et de ruralité, cette province est un centre économique historique pour le Canada, avec des industries clés telles que la pêche, la construction navale et, plus récemment, les technologies de l'information et les services.",
  descripNouvelleEcosse2: "En tant que porte d'entrée de l'Atlantique, la Nouvelle-Écosse bénéficie d'une position stratégique pour le commerce international. Son port d'Halifax, l'un des plus grands ports en eaux profondes d'Amérique du Nord, la connecte aux marchés mondiaux et contribue à une économie en pleine diversification.",
  advantageNouvelleEcosse: "Grâce à son emplacement unique et ses ressources maritimes, la Nouvelle-Écosse offre des opportunités économiques diversifiées. Voici un aperçu de quatre villes stratégiques de la Nouvelle-Écosse.",
  HalifaxDescription: "Halifax, la capitale et la plus grande ville de la Nouvelle-Écosse, est le centre économique, culturel et éducatif de la province. Son port d'eaux profondes est un hub pour le commerce international et la logistique maritime. En plus de son rôle dans la défense et la construction navale, Halifax accueille de nombreuses institutions d'enseignement supérieur et un secteur financier en croissance.",
  SydneyDescription: "Sydney, sur l'île du Cap-Breton, a été historiquement un centre pour l'industrie du charbon et de l'acier. Aujourd'hui, elle s'oriente vers le tourisme, avec le Cabot Trail à proximité, ainsi que vers l'énergie renouvelable, notamment éolienne.",
  TruroDescription: "Truro, appelée le carrefour de la Nouvelle-Écosse, est stratégiquement située pour le transport et la logistique. La ville est également un centre important pour l'agriculture et la transformation alimentaire.",
  LunenburgDescription: "Lunenburg, classée au patrimoine mondial de l'UNESCO, est un haut lieu du patrimoine maritime et un pôle de la construction navale et de la pêche. Le tourisme culturel y joue un rôle majeur.",
  conclusionNouvelleEcosse: "Halifax, Sydney, Truro et Lunenburg contribuent toutes à la prospérité de la Nouvelle-Écosse. Leurs économies sont diversifiées et soutiennent la province dans sa quête de croissance durable et de développement économique.",

  // Québec
  nomQuebec: 'Québec',
  descripQuebec1: "Le Québec, la plus grande province canadienne par sa superficie, se distingue par sa diversité culturelle, sa richesse naturelle et son leadership dans plusieurs industries, notamment l'aérospatiale, les TI, et l'agroalimentaire. L'histoire francophone du Québec ajoute une dimension unique à son patrimoine culturel.",
  descripQuebec2: "Économiquement, le Québec est crucial pour le Canada. La province est en tête dans les énergies renouvelables, notamment grâce à l'hydroélectricité, et continue de diversifier ses secteurs économiques, tout en promouvant le développement durable et l'innovation.",
  advantageQuebec: "Avec des ressources naturelles abondantes, une économie diversifiée, et une culture distincte, le Québec offre des opportunités économiques uniques.",
  MontrealDescription: "Montréal, centre économique et culturel du Québec, est un pôle pour les industries créatives, les TI, et la recherche universitaire. Sa diversité culturelle et son dynamisme attirent des talents de partout dans le monde.",
  QuebecCityDescription: "La ville de Québec, capitale provinciale, est connue pour son riche patrimoine et son rôle comme centre administratif. Elle développe des secteurs comme les sciences de la vie et le tourisme.",
  SherbrookeDescription: "Sherbrooke est un centre universitaire et industriel majeur. La ville mise sur la recherche en santé, les technologies propres, et les matériaux avancés.",
  TroisRivieresDescription: "Trois-Rivières, avec ses industries papetières et forestières, est un centre industriel clé, particulièrement pour le commerce le long du Saint-Laurent.",
  conclusionQuebec: "Montréal, Québec, Sherbrooke et Trois-Rivières sont des piliers économiques pour le Québec, intégrant tradition et innovation dans divers secteurs.",

  // Saskatchewan
  nomSaskatchewan: 'Saskatchewan',
  descripSaskatchewan1: "Saskatchewan, au cœur des Prairies canadiennes, est célèbre pour ses terres agricoles vastes et ses ressources naturelles abondantes, en particulier le blé, l'uranium et la potasse.",
  descripSaskatchewan2: "Bien que majoritairement rurale, la Saskatchewan connaît une croissance dans ses centres urbains et attire des investissements dans les technologies propres, la recherche scientifique et les industries vertes.",
  advantageSaskatchewan: "Avec ses ressources naturelles et agricoles, la Saskatchewan répond aux besoins mondiaux en nourriture, énergie et minéraux.",
  SaskatoonDescription: "Saskatoon, centre économique et académique en croissance, est axée sur l'agriculture, la biotechnologie et l'innovation.",
  ReginaDescription: "Regina, capitale provinciale, est un centre pour l'énergie et la technologie.",
  PrinceAlbertDescription: "Prince Albert, à la lisière de la forêt boréale, est un pôle pour les industries forestières et minières.",
  MooseJawDescription: "Moose Jaw est un centre pour l'agriculture, la transformation alimentaire, et l'industrie militaire.",
  conclusionSaskatchewan: "Saskatoon, Regina, Prince Albert et Moose Jaw sont les moteurs de la Saskatchewan, soutenant une économie agricole et industrielle en pleine évolution.",

  // Terre-Neuve-et-Labrador
  nomTerreNeuveLabrador: 'Terre-Neuve-et-Labrador',
  descripTerreNeuveLabrador1: "Terre-Neuve-et-Labrador, province la plus à l'est du Canada, est reconnue pour ses paysages grandioses et son patrimoine maritime.",
  descripTerreNeuveLabrador2: "L'économie repose en grande partie sur la pêche, l'exploitation pétrolière offshore, et les mines, des secteurs qui dominent l'économie.",
  advantageTerreNeuveLabrador: "Avec ses ressources naturelles et maritimes, Terre-Neuve-et-Labrador est essentielle pour le Canada atlantique.",
  StJohnsDescription: "St. John's, capitale provinciale, est le centre économique et culturel de la province, connu pour son patrimoine architectural unique.",
  CornerBrookDescription: "Corner Brook est un centre industriel pour la papeterie, et un accès touristique au parc national du Gros-Morne.",
  LabradorCityDescription: "Labrador City, au cœur de l'industrie minière, est un important producteur de minerai de fer.",
  HappyValleyGooseBayDescription: "Happy Valley-Goose Bay, avec sa base aérienne, est un pôle de défense et logistique.",
  conclusionTerreNeuveLabrador: "Les villes de Terre-Neuve-et-Labrador, notamment St. John’s, Corner Brook, Labrador City et Happy Valley-Goose Bay, sont vitales pour l'économie provinciale, mêlant tradition et modernité.",

      // News Titles and Descriptions
      news_title1: 'Interview du Président de la Chambre de Commerce Canada Afrique sur Jambo TV',
      news_description1: 'Création d\'une plateforme numérique qui met en relation les entreprises canadiennes et africaines. Cette plateforme permet le partage d\'informations sur les produits, services, opportunités d\'investissement et projets en cours.',
      news_title2: 'Exode des cerveaux : l’Afrique se vide au profit du Canada',
      news_description2: 'Organisation de webinaires sur des sujets clés tels que l\'entrée sur le marché, la culture d\'affaires, la législation locale et les pratiques commerciales durables.',
      news_title3: 'Québec cesse de recruter des infirmières en Afrique pour des raisons « éthiques »',
      news_description3: 'Organisation de missions commerciales régulières au Canada et en Afrique pour permettre aux entreprises de rencontrer des partenaires potentiels et de découvrir les marchés locaux.',
      news_title4: 'Exploiter les possibilités pour l’hydrogène vert au Canada atlantique',
      news_description4: 'Exploration des possibilités offertes par le développement de l’hydrogène vert au Canada atlantique pour améliorer la transition énergétique et renforcer la coopération avec les pays africains pour une énergie propre.',
      ...
      devenir_membre: {
        ...
        choose_membership_category: 'Choisir votre catégorie d\'adhésion pour la CCCA',
        subscribe: 'Souscrire',
        ...
        membership_levels: {
          student: {
            ...
            description: 'Pour les étudiants ayant à cœur le monde des affaires et voulant être en contact avec la communauté d’affaires au Québec et en Afrique',
            benefits: [
          ...
          startup: {
            title: 'Startup',
            description: 'Pour les nouvelles entreprises en activité depuis moins de deux ans',
            benefits: [
              'Reconnaissance lors de nos activités ou de nos communications',
          ...
          organization: {
            title: 'Organisme',
            description: 'Pour les organisations à but non lucratif et instituts',
            benefits: [
              'Prix partenaire-client lors des événements publics',
              'Exclusivité pour les événements réservés aux partenaires-clients',
          ...
          political: {
            title: 'Politique',
            description: 'Pour les personnes politiques désirant rencontrer la communauté d’affaires en Afrique et au Canada',
            benefits: [
              'Prix partenaire-client lors des événements publics',
              'Exclusivité pour les événements réservés aux partenaires-clients',
              'Pour une personne'
          ...
          exclusive: {
            title: 'Exclusif',
            description: 'Un seul partenaire par expertise : « Partenaire mention du service officiel de la CCCA »',
            benefits: [
      ...
      newsletter_benefit1: 'Ne ratez plus les activités profitables pour votre organisation',
      newsletter_benefit2: 'Recevez les plus récentes nouvelles directement par courriel',
      newsletter_benefit3: 'Restez au cœur de l\'activité économique de la métropole',
      ...
      newsletter_success: 'Merci de vous être abonné à notre infolettre avec l\'adresse: {{email}}',
        ...
        advantage_secure_investment_desc: 'La CCCA comme acteur incontournable pour vous offrir des opportunités.',
        advantage_network_strength: 'La Force du réseau',
        advantage_network_strength_desc: 'Tisser des liens avec d\'autres gens d\'affaires pour une croissance assurée.',
        advantage_access_training: 'Accès aux formations',
        advantage_access_training_desc: 'Répondre aux besoins des membres avec des formations diversifiées et accessibles.',
        advantage_visibility: 'Visibilité',
        advantage_visibility_desc: 'La CCCA offre un espace publicitaire « Entreprise du mois ». Réservez votre mois!',
        advantage_influential_partnership: 'Un partenariat influent',
        advantage_influential_partnership_desc: 'Opportunités d’implication en tant que partenaire annuel ou sponsor d’événement.',
        advantage_exclusive_offers: 'Offres exclusives',
        advantage_exclusive_offers_desc: 'Économisez avec des promotions offertes PAR les membres POUR les membres de la CCCA.',

        // Home Component
        upcoming_event: 'Évènement à Venir',
        main_event_description: 'Salon de Construction Durable et Transformation du Bois : Un Pont Entre le Canada et l’Afrique',
        ...
        activities: 'Activités',
         ...
         // Event Titles and Descriptions
         event_title1: 'Salon de Construction Durable et Transformation du Bois : Un Pont Entre le Canada et l’Afrique',
         event_description1: "Le Salon de Construction Durable et Transformation du Bois, prévu pour novembre 2025, sera un événement international majeur réunissant des acteurs clés des secteurs de la construction et de la transformation du bois provenant du Canada et de plusieurs pays d’Afrique. Cet événement se tiendra sous le thème “Innovations, Développement Durable et Coopération Internationale”.",
         event_title2: 'Salon des municipalités Quebec Afrique francophone (SAMUQAF)',
         event_description2: 'Le Salon des municipalités Quebec Afrique francophone (SAMUQAF) rassemble des communautés...',
         event_title3: 'Salon International du Café (SICAF)',
         event_description3: "Le Salon International du Café (SICAF) est dédié à la promotion du café africain...",
         event_title4: 'Programme de Perfectionnement des Capacités des Dirigeants et Entrepreneurs (PPCDE)',
         event_description4: "Le Programme de Perfectionnement des Capacités des Dirigeants et Entrepreneurs offre une formation...",
 
         // Section Titles and Descriptions
         objectives_title: 'Objectifs du Salon',
         objectives_intro: 'Le salon vise à :',
         objective1: 'Promouvoir les pratiques de construction durable grâce aux innovations technologiques et aux matériaux écologiques.',
         objective2: 'Favoriser les échanges entre les professionnels du bois, les architectes, les ingénieurs, les investisseurs et les décideurs politiques des deux continents.',
         objective3: 'Encourager les partenariats commerciaux et technologiques entre le Canada, reconnu pour ses pratiques avancées en gestion forestière, et les pays africains, riches en ressources forestières.',
 
         why_participate: 'Pourquoi Participer ?',
         why_participate_intro: 'Le salon vise à :',
         business_opportunity: 'Opportunités d’affaires: Le salon est une plateforme pour établir des relations commerciales solides entre les entreprises canadiennes et africaines, ouvrant la voie à des projets conjoints dans les domaines du bâtiment et de l’industrie du bois.',
         exchange_professionals: 'Favoriser les échanges entre les professionnels du bois, les architectes, les ingénieurs, les investisseurs et les décideurs politiques des deux continents.',
         tech_partnerships: 'Encourager les partenariats commerciaux et technologiques entre le Canada, reconnu pour ses pratiques avancées en gestion forestière, et les pays africains, riches en ressources forestières.',
 
         location_quebec: 'Québec',

         //actualités
         news_title1: 'Interview du Président de la Chambre de Commerce Canada Afrique sur Jambo TV',
      news_description1: 'Création d\'une plateforme numérique qui met en relation les entreprises canadiennes et africaines. Cette plateforme pourrait permettre le partage d\'informations sur les produits, services, opportunités d\'investissement et projets en cours.',
      news_title2: 'Exode des cerveaux : l’Afrique se vide au profit du Canada',
      news_description2: 'Organisation de webinaires sur des sujets clés tels que l\'entrée sur le marché, la culture d\'affaires, la législation locale et les pratiques commerciales durables.',
      news_title3: 'Québec cesse de recruter des infirmières en Afrique pour des raisons « éthiques »',
      news_description3: 'Organisation de missions commerciales régulières, tant au Canada qu’en Afrique, pour permettre aux entreprises de rencontrer des partenaires potentiels et de découvrir les marchés locaux.',
      news_title4: 'Exploiter les possibilités pour l’hydrogène vert au Canada atlantique',
      news_description4: 'Exploration des possibilités offertes par le développement de l’hydrogène vert au Canada atlantique, visant à améliorer la transition énergétique et à renforcer la coopération avec les pays africains pour une énergie propre.',
      ...
      incubation: "Incubations",
        ...
        event1_desc: "Un événement international réunissant les principaux acteurs des secteurs de la construction et de la transformation du bois provenant du Canada et de divers pays d'Afrique.",
        event2_title: 'Forum des Municipalités Francophones',
        event2_desc: 'Un forum collaboratif abordant les défis de main-d\'œuvre et économiques entre le Québec et les municipalités africaines.',
        event3_title: 'Salon International du Café',
        event3_desc: 'Une plateforme unique pour promouvoir le café africain et établir des liens avec les distributeurs canadiens.',
        event4_title: 'Programme de Développement des Capacités des Dirigeants et Entrepreneurs',
        event4_desc: "Un programme en partenariat avec des universités canadiennes offrant des formations pour les dirigeants africains et les entrepreneurs.",

        // Home Component Activities Data
        activity1_title: 'Plateforme d’Échange Commercial',
        activity1_desc: 'Création d\'une plateforme numérique reliant les entreprises canadiennes et africaines.',
        activity2_title: 'Webinaires et Ateliers de Formation',
        activity2_desc: 'Organisation de webinaires sur des sujets comme l\'entrée sur le marché et la culture d\'affaires.',
        activity3_title: 'Missions Commerciales',
        activity3_desc: 'Missions commerciales régulières au Canada et en Afrique pour connecter les entreprises et explorer de nouveaux marchés.',

        // Presentations Component
        presentationDescription: "La Chambre de Commerce Canada Afrique est un organisme chargé de représenter les intérêts des entreprises commerciales, industrielles et de services, d’assurer la formation des entrepreneurs et d’apporter un appui aux entreprises. Elle représente les professionnels des secteurs du commerce, de l'industrie et des services auprès des autorités publiques locales et internationales intervenant dans les domaines relevant de ses missions. La CCCA assume des missions à caractère représentatif, consultatif, de soutien et de promotion.",
        ...
        servicesData: [
          {
            ...
            description: "La CCCA offre un service complet en matière de démarrage d’entreprise au Canada.",
          },
          {
            title: 'Francophonie',
            description: 'La CCCA est avant tout un marché économique francophone reliant la francophonie canadienne et africaine.',
          },
          {
            title: 'Repreneuriat',
            description: 'La CCCA se donne pour mandat d’attirer des investisseurs et entrepreneurs africains souhaitant reprendre une entreprise.',
          },
          {
            title: 'Coopération Internationale',
            description: "La CCCA regroupe des expertises pour conduire des missions commerciales au Canada et en Afrique.",
          },
          {
            title: 'Maillage d\'Affaires',
            description: 'La CCCA offre un programme de maillage d’affaires à travers des salons et forums B-to-B et B-to-C.',
          },
          {
            title: 'Formations',
            description: 'Ce programme de formation est donné par des experts en développement d’affaires basés au Canada et en Afrique.',
          },
          {
            title: 'Incubations',
            description: 'La CCCA accompagne des entrepreneurs du Canada de l’idéation au démarrage d’une entreprise via le programme "CCCA-Propuls".',
          }
        ],

        // Navbar Africa Offices Data
        africaOfficesData: [
          { title: 'Afrique Centrale', countries: ['Cameroun', 'Angola', 'Congo', 'Tchad', 'Gabon', 'Sao Tomé-et-Principe', 'Guinée équatoriale', 'République Centrafricaine'] },
          { title: 'Afrique de l\'Ouest', countries: ['Nigeria', 'Burkina Faso', 'Cap-vert', "Côte d'Ivoire", 'Gambie', 'Ghana', 'Guinée', 'Guinée-Bissau', 'Libéria', 'Mali'] },
          { title: 'Afrique de L\'est', countries: ['Burundi', 'Kenya', 'Djibouti', 'Malawi', 'Maurice', 'Mozambique', 'Rwanda', 'Ouganda', 'Zambie'] },
          { title: 'Afrique du Nord', countries: ['Algérie', 'Égypte', 'Libye', 'Maroc', 'Mauritanie', 'Soudan', 'Tunisie'] },
          { title: 'Afrique Australe', countries: ['Botswana', 'Lesotho', 'Namibie', 'Suaziland', 'Afrique du Sud'] },
      ...
      // Service Descriptions
      entrepreneurship_para_1: "La CCCA offre un service complet en matière de démarrage d’entreprise au Canada. À travers son réseau d’experts en entrepreneuriat au Canada, les membres de la CCCA peuvent solliciter nos services afin de les accompagner à démarrer et à réaliser leurs entreprises au Canada ou dans un pays d’Afrique où elle est représentée.",
      entrepreneurship_para_2: "La CCCA s’appuie sur des partenariats solides ainsi que sur des organismes d’accompagnement en entrepreneuriat au Canada.Ainsi, nous pouvons suggérer des idées d’entreprises innovantes, faire un accompagnement dans la rédaction du projet entrepreneurial, le plan d’affaires ainsi que la planification stratégique, et également le plan de communication marketing.",
      entrepreneurship_para_3: "En outre, le service d’appui à l’accompagnement de la CCCA est structuré de son incubateur intégré qui offre un environnement complet et des outils clés pour démarrer une entreprise, ouvrir une filiale ou réactiver une entreprise dormante au Canada et en Afrique",
      entrepreneurship_partners: "Nos Partenaires",

      repreneurship_para: "La CCCA se donne pour mandat d’attirer des investisseurs, des gens d’affaires basés en Afrique et qui souhaitent reprendre une entreprise en général et au Québec en particulier. Le repreneuriat est un programme économique qui est particulièrement mis en avant par le gouvernement du Québec à travers le ministère de l’économie, de l’innovation et de l’énergie ainsi que le ministère de l’immigration, de la francisation et de l’intégration.Ce programme repose sur une problématique: près de 25% des 65 ans et plus ont l’intention de fermer leurs entreprises par manque de relève.Moins de 20% des entrepreneurs résidants au Québec ont l’intention de reprendre les entreprises existantes.Plus de 60% sont plutôt intéressés à démarrer une entreprise.",
      repreneurship_benefits: "Les avantages avec le programme du repreneuriat sont directement perceptibles :",
      repreneurship_benefit_1: "Il est plus facile d’obtenir du financement parce que l’entreprise présente déjà un historique financier et des actifs",
      repreneurship_benefit_2: "L’image de marque et la réputation de l’entreprise sont déjà établies",
      repreneurship_benefit_3: "Les produits au service de l’entreprise sont déjà bien alignés dans un marché concurrentiel",
      repreneurship_benefit_4: "Il y a peu de risque de faillite car l’entreprise est déjà dans sa phase productive",
      repreneurship_benefit_5: "Il existe déjà une relation entre les clients et les fournisseurs",
      repreneurship_benefit_6: "Le personnel est déjà suffisamment formé et aguerri",
      repreneurship_benefit_7: "Dans certains camps, l’ancien dirigeant peut aider à faire la transition pour que la reprise soit optimale",

      francophonie_para_1: "La CCCA est avant tout un marché économique francophone qui relie la francophonie canadienne et celle africaine.Elle s’ouvre ensuite vers les économies anglophones afin de susciter des dynamiques d’affaires impulsées par la volonté de commercialiser en langue française. À travers la francophonie, la CCCA entend attirer les économies diverses au sein d’un écosystème drainé par la langue française.La CCCA offre également des espaces d’apprentissage du français comme langue d’affaires.",
      francophonie_para_2: "À ce titre, elle offre un programme de francisation à tout entrepreneur ou investisseur qui choisit de s’installer au Québec ou au sein de communautés francophones au canada.",

      international_cooperation_para: "La CCCA regroupe en son sein des expertises pour conduire des missions commerciales aussi bien au canada qu’en Afrique.Ce service vise à accompagner des gouvernements, institutions publiques ou para publiques, des organisations à but non lucratif, des entreprises, qui souhaitent effecteur une mission commerciale, de prospection ou d’exploration en vue de générer en développement d’affaires de partenariats ou de représentations.",

      business_networking_para_1: "La CCCA offre un programme de maillage d’affaires à travers des salons, des forums, des foires organisées sous forme de rencontre B to B et B to C et dont l’objectif est de permettre aux participants de nouer ou conclure des alliances d’affaires entre le canada et l’Afrique.À ce titre, la CCCA a plusieurs concepts évènementiels d’affaires qui se tiennent annuellement au canada ou dans l’un des pays africains où elle possède une délégation.",
      business_networking_para_2: "La CCCA collabore également avec des partenaires organisateurs pour attirer des délégations canadiennes d’entrepreneurs ou investisseurs pour participer à des évènements économiquement importants en Afrique, et inversement, cette dernière à travers ses délégués pays, mobilise des délégations africaines d’entrepreneurs et ou d’investisseurs pour prendre part à des événements d’affaires organisés au Canada.",

      incubation_para: "La CCCA à travers son programme d’incubation et d’accélération intitué « CCCA - Propuls » accompagne des entrepreneurs résident au canada de l’idéation au démarrage d’une entreprise.A travers ses 4 parcours, CCCA - Propuls vous permettra d’acquérir des ressources  clés pour démarrer une entreprise au Canada et la réaliser.",

      training_para: "La CCCA à travers son programme De formation accompagne des entrepreneurs résident en afrique de l’idéation au démarrage d’une entreprise.A travers ses 2 grands types de formations parcours, CCCA - Propuls vous permettra d’acquérir des ressources  clés pour démarrer une entreprise au Canada et la réaliser.",

      // Programs, Partners, and Other Sections
      leadership_program_title: "Programme de perfectionnement des capacités des dirigeants et entrepreneurs (PPCDE)",
      leadership_program_description: "Un programme approfondi qui se connecte avec les principales universités pour doter les dirigeants de compétences...",
      repreneurship_program_title: "Programme de formation sur le repreneuriat",
      repreneurship_program_description: "Formation spécialisée visant à aider les entrepreneurs à reprendre des entreprises existantes.",
      ...
      university_laval_program_1: "Certificat universitaire en gouvernance des sociétés",
      ...
      boreal_program_2: "Commerce international (Import-Export Canada-Afrique)",
      ...
      subscribe_to_service: "Souscrire à {{service}}",
        ...
        newsletter_info: 'Pour rester au cœur de l’activité économique de la métropole',
        ...
        designed_by: 'Conçu par',
         ...
         event_title1: 'Salon de Construction Durable et Transformation du Bois : Un Pont Entre le Canada et l’Afrique',
         event_description1: 'Le Salon de Construction Durable et Transformation du Bois, prévu pour novembre 2025, sera un événement international majeur réunissant des acteurs clés des secteurs de la construction et de la transformation du bois provenant du Canada et de plusieurs pays d’Afrique. Cet événement se tiendra sous le thème “Innovations, Développement Durable et Coopération Internationale”.',
         event_title2: 'Salon des Municipalités Francophones du Québec et Afrique (SAMUQAF)',
         event_description2: 'Organisé par la Chambre de Commerce Québec-Afrique pour aborder les défis de main-d’œuvre...',
         event_title3: 'Salon International du Café (SICAF)',
         event_description3: 'Le Salon International du Café, organisé pour la première fois au Canada, est une plateforme unique...',
         event_title4: 'Programme de Perfectionnement des Capacités des Dirigeants et Entrepreneurs (PPCDE)',
         event_description4: 'Le programme PPCDE propose une formation de perfectionnement en collaboration avec HEC Montréal, Université Laval...',
 
         past_event_title1: 'Rencontre d’Affaires de la Francophonie (RAF24)',
         past_event_description1: 'Lorem Ipsum est un texte factice de l\'industrie de l\'impression et de la composition.',
         past_event_title2: 'Rencontre d’Affaires de la Francophonie (RAF24)',
         past_event_description2: 'Lorem Ipsum est un texte factice de l\'industrie de l\'impression et de la composition.',
 
        

        // Objectif Component
        emerging_markets_access: 'Accès aux Marchés Émergents',
        emerging_markets_access_desc: 'Les petites et moyennes entreprises (PME) canadiennes ont des opportunités uniques pour pénétrer les marchés africains, souvent moins concurrentiels et plus ouverts à l’innovation. Les secteurs de niche, comme les technologies vertes ou l’agriculture durable, offrent des opportunités spécifiques pour les PME.',
        support_programs: 'Programmes de Soutien',
        support_programs_desc: 'Divers programmes canadiens existent pour aider les PME à explorer et à s’implanter sur les marchés africains, y compris le financement, le mentoring, et le soutien logistique.',
        find_ccca_nearby: 'Trouvez la CCCA proche de chez vous',
        access_via_ccca: 'Ceux à quoi vous avez accès via La CCCA:',
        network_of_5000_entrepreneurs: 'Un réseau de prêt de 5000 entrepreneurs',
        representatives_in_africa: 'Avec plus de 25 réprésentants en Afrique',

        news: 'Actualités',
        
        // Services Component
        jambo_tv_interview: "Interview du Président de la Chambre de Commerce Canada Afrique sur le plateau de Jambo TV à Canal2",
        brain_drain_africa: "Exode des cerveaux : l’Afrique se vide au profit du Canada",
        quebec_recruitment: "Québec cesse de recruter des infirmières en Afrique pour des raisons « éthiques »",
        green_hydrogen_opportunities: "Exploiter les possibilités pour l’hydrogène vert au Canada atlantique",


        // Navbar Canada Representation Data
        canadaRepresentationData: ['Alberta', 'Colombie-Britannique', 'Île-du-Prince-Édouard', 'Manitoba', 'Nouvelle-Écosse', 'Québec', 'Saskatchewan', 'Terre-Neuve-et-Labrador'],
        ...
        activitiesData: [
          {
            ...
            description: "Création d'une plateforme numérique qui met en relation les entreprises canadiennes et africaines.",
          },
          {
            title: 'Webinaires et Ateliers de Formation',
            description: "Organisation de webinaires sur des sujets clés comme la culture d'affaires.",
          },
          {
            title: 'Missions Commerciales',
            description: 'Organisation de missions commerciales régulières au Canada et en Afrique.',
          },
          {
            title: 'Foires et Salons Professionnels',
            description: "Participation à des salons commerciaux pour mettre en avant les entreprises des deux régions.",
          },
          {
            title: 'Programme de Mentorat',
            description: "Mise en place d'un programme de mentorat pour accompagner les startups et PME.",
          },
          {
          ...
          },
          {
            ...
            description: "Organisation d'un forum annuel pour discuter des opportunités économiques.",
          },
          {
          ...
          },
          {
            ...
            description: "Utilisation des réseaux sociaux pour promouvoir les entreprises.",
          },
          {
            title: 'Soutien à la Francophonie',
            description: "Développement d'initiatives pour promouvoir les échanges au sein de la francophonie.",
          }
        ]
      },
    },
